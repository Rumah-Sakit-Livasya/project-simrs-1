                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label for="create-bulan">Bulan <i class="fas fa-info-circle text-primary"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label for="create-pic">PIC (Person In Charge) <i
                                ...
                                <div class="form-group mt-3">
                                    <div class="frame-wrap">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" id="create-baku"
                                                name="satuan" value="baku">
                                            <label class="custom-control-label" for="create-baku">Baku</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" id="create-persen"
                                                name="satuan" value="persen">
                                            <label class="custom-control-label" for="create-persen">Persen (%)</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" id="create-rupiah"
                                                name="satuan" value="rupiah">
                                            <label class="custom-control-label" for="create-rupiah">Rupiah (Rp)</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
