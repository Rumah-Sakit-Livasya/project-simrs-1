<div class="modal fade p-0" id="edit-pengajuan-libur" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form autocomplete="off" action="#" novalidate method="post" id="update-day-off-req-form"
                enctype="multipart/form-data">
                @method('POST')
                @csrf
                <div class="modal-header">
                    <h5 class="font-weight-bold">Update Cuti</h5>
                ...
                <div class="modal-body py-0 mt-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" id="date" class="form-control" placeholder="Select a date"
                ...
                <div class="modal-body py-0 mt-2">
                    <div class="form-group mb-3">
                        ...
                        <div class="custom-file">
                            <input type="file" onchange="previewImageDayOff()" name="photo"
                ...
                <div class="modal-body py-0 mt-2">
                    <div class="form-group">
                        ...
                        <select class="select2 form-control w-100" id="is_approved" name="is_approved">
