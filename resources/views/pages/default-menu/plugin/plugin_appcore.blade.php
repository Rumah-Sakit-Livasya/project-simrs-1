    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            @component('inc.subheader', ['subheader_title' => 'st_type_5'])
                ...
                @endslot
                @slot('sh_titile_main')
                    App.core.js <sup class='badge badge-danger fw-500'>CORE</sup>
                @endslot
                @slot('sh_descipt')
                            ...
                            <table class="table table-hover table-bordered m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fs-sm">
                                            Push array to <code>body</code> tag. See <a href="/settings_saving_db">saving to
                                                database</a> for more details
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="fs-sm">
                                            Fetch class names from <code>body</code> and convert them to JSON string. See <a
                                                href="/settings_saving_db">saving to database</a> for more details
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                            ...
                            <table class="table table-hover table-bordered m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fs-sm">
                                            Push array to <code>body</code> tag. See <a href="/settings_saving_db">saving
                                                to database</a> for more details
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
