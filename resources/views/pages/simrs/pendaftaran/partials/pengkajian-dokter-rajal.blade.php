                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Tanggal / Jam</td>
                            <td colspan="2">
                                <input type="text" name="awal_tgl_rajal" class="form-control d-inline"
                                    style="width: 40%;">
                                /
                                <input type="text" name="awal_jam_rajal" class="form-control d-inline"
                                    style="width: 40%;">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" id="edukasi_terapi" name="awal_edukasi2" value="terapi"
                            ...
                            <td colspan="2">
                                <div class="form-check">
                                    <input type="checkbox" id="rencana_rawat_jalan"
                                        name="awal_rencana_tindak_lanjut1" value="akut" class="form-check-input">
                                    <label for="rencana_rawat_jalan" class="form-check-label">Rawat Jalan</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" id="rencana_rawat_inap" name="awal_rencana_tindak_lanjut2"
                                        value="kronis" class="form-check-input">
