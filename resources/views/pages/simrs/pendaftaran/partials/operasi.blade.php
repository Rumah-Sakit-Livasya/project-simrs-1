                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-xs btn-outline-warning waves-effect waves-themed btn-edit-order" 
                                    data-id="${row.id}" title="Edit Order">
                                <i class="fal fa-edit"></i>
                            </button>
                            <button type="button" class="btn btn-xs btn-outline-danger waves-effect waves-themed btn-delete-order" 
                                    data-id="${row.id}" title="Hapus Order">
