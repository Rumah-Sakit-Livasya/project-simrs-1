    <div class="card-head">
        <div class="header-pasien">
            <img src="http://192.168.1.253/testing/include/avatar/man-icon.png" class="avatar">
            <div>
                <input type="text" id="fokus" class="hack-view">
                <div class="name" onclick="reg_patient()">DIMAS AIRLANGGA </div>
                <div class="birth">07 Mar 2015 (9thn 5bln 15hr) <i class="mdi mdi-gender-male"></i></div>
                <div class="rm">RM 00-26-52</div>
                <div class="birth">Jaminan pribadi</div>
                <div>
                    Info Billing: <span title="Billing: 10.000, Proses Order: 0"
                        style="color: green;
        font-weight: 400;text-decoration: underline; margin-right: 5px;"
                        id="info_billing">10.000</span><i class="fa fa-refresh pointer" id="get_info_bill"></i>
                </div>
                <!-- tambahan by rizal -->
                <div class="detail-alergi" onclick="openForm()">Tidak ada alergi</div>
            </div>
            <img src="http://192.168.1.253/testing/include/avatar/man-doctor.png" class="avatar">
            <div>
                <div class="name">dr. H. Iing Syapei Sudjono Sp.OG</div>
                <div class="birth">KLINIK OBGYN</div>
                <div class="rm">Reg 2408220002 (22 Aug 2024)</div>
    ...
    <form method="post" class="form" id="form-builder" autocomplete="off" enctype='multipart/form-data'>
        ...
        <div class="card-actionbar">
            <div class="card-actionbar-row">
                <button class="btn btn-primary" id="histori_pengkajian" type="button"><i class="mdi mdi-history"></i>
                    Histori</button>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-daterange input-group col-sm-8" id="demo-date-range">
                                ...
                                <div class="input-group-content">
                                    <input class="form-control time" name="jam_masuk" id="jam_masuk"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input class="form-control" id="sp02" name="sp02" value=""
                                type="text">
                        ...
                        <div class="form-group">
                            <select name="asupan_makan" id="asupan_makan" class="sel2">
                                ...
                                <option value="Berkurang, penurunan nafsu makan/kesulitan menerima makan"
                                    data-skor="1">Berkurang, penurunan nafsu makan/kesulitan menerima makan</option>
                            </select>
                        ...
                        <div class="input-group">
                            <div
                                ...
                                <div>
                                    ...
                                    <img src="http://192.168.1.253/testing/include/images/ttd_blank.png"
        ...
        <div class="card-actionbar">
            <div class="card-actionbar-row">
                <a href="#!" class="btn btn-primary waves-effect waves-light pull-left"><span
                        class="mdi mdi-printer print-pengkajian" data-pkid="" data-pregid="183016"
                        data-ftid="-24" data-printtype="{print_type}" data-link="{link}"> Print</span></a>
                <button type="button" class="btn btn-warning waves-effect waves-light save-form"
                    data-dismiss='modal' data-status="0"><span class="mdi mdi-content-save"></span> Simpan
                    (draft)</button>
