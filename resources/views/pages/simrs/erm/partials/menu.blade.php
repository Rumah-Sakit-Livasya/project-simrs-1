        ...
        <ul class="nav nav-tabs action-erm" role="tablist">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item"
                        href="{{ route($path . '.catatan-medis', ['registration' => $registration->registration_number, 'menu' => 'resume_medis_rajal']) }}">Resume
                        Medis</a>
                    <a class="dropdown-item"
    ...
    @else
        <ul class="nav nav-tabs action-erm" role="tablist">
            ...
            @if ($path == 'igd')
                <li class="nav-item dropdown">
                    <a class="dropdown-item nav-link"
                        href="{{ route($path . '.daftar-pasien', ['registration' => $registration->registration_number, 'menu' => 'triage']) }}"
                        role="tab">Triage</a>
                </li>
            @endif
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item"
                        href="{{ route($path . '.daftar-pasien', ['registration' => $registration->registration_number, 'menu' => 'ews_anak']) }}"
                        role="tab">Early Warning Scoring System (Anak)</a>
                    <a class="dropdown-item"
                        href="{{ route($path . '.daftar-pasien', ['registration' => $registration->registration_number, 'menu' => 'ews_dewasa']) }}"
                        role="tab">Early Warning Scoring System (Dewasa)</a>
                    <a class="dropdown-item"
                        href="{{ route($path . '.daftar-pasien', ['registration' => $registration->registration_number, 'menu' => 'ews_obstetri']) }}"
                        role="tab">Early Warning Scoring System (Obstetri)</a>
                    <a class="dropdown-item"
                        href="{{ route($path . '.daftar-pasien', ['registration' => $registration->registration_number, 'menu' => 'assesment_gadar']) }}"
                        role="tab">Assesment Keperawatan Gawat Darurat</a>
                    <a class="dropdown-item"
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item"
                        href="{{ route($path . '.daftar-pasien', ['registration' => $registration->registration_number, 'menu' => 'resume_medis_rajal']) }}">Resume
                        Medis</a>
                    <a class="dropdown-item"
