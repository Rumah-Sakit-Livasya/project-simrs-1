        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body">
                ...
                <div class="text-center mt-3">
                    ...
                    <button class="btn btn-sm btn-outline-danger" onclick="clearCanvasSingle()">
                        🗑 Bersihkan
                    </button>
                    <button class="btn btn-sm btn-outline-secondary" onclick="undoSingle()">
                        ↩️ Batal
                    </button>
                    <button class="btn btn-sm btn-success" onclick="saveSignatureSingle()" id="btn_save_ttd"
