            ...
            <div class="row">
                <div class="col-6">
                    <input type="text" name="tgl_masuk" class="form-control datepicker"
                        value="{{ $pengkajian->waktu_masuk
                            ? $pengkajian->waktu_masuk->format('d-m-Y')
                            : (isset($registration->registration_date) && $registration->registration_date
                ...
                <div class="col-6">
                    <input type="time" name="jam_masuk" class="form-control"
                        value="{{ $pengkajian->waktu_masuk
                            ? $pengkajian->waktu_masuk->format('H:i')
                            : (isset($registration->registration_date) && $registration->registration_date
                                ? \Carbon\Carbon::parse($registration->registration_date)->format('H:i')
                                : '') }}">
                </div>
            </div>
        </div>
