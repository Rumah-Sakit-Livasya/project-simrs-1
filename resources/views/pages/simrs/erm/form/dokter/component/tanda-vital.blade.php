{{-- Beri ID unik pada pembungkusnya --}}
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    {{-- Beri class 'vital-input' untuk memudahkan seleksi --}}
                    <input type="text" name="tanda_vital[pr]" class="form-control vital-input"
                        value="{{ $data['tanda_vital']['pr'] ?? ($pengkajianNurse['pr'] ?? '') }}">
                    <div class="input-group-append"><span class="input-group-text">x/menit</span></div>
                </div>
            </div>
        </div>
        {{-- ... Input Nadi (PR), Respirasi (RR), Tensi (BP), Suhu (T) ... --}}
        {{-- Pastikan semua input diberi class 'vital-input' --}}
        <div class="col-md-3">
            <div class="form-group">
                <label>Respirasi (RR)</label>
                <div class="input-group">
                    <input type="text" name="tanda_vital[rr]" class="form-control vital-input"
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="tanda_vital[bp]" class="form-control vital-input"
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label>Suhu (T)</label>
                <div class="input-group">
                    <input type="text" name="tanda_vital[temperatur]" class="form-control vital-input"
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    {{-- 'vital-input' juga ditambahkan ke field kalkulasi BMI --}}
                    <input type="text" id="height_badan" name="tanda_vital[height_badan]"
                        class="form-control calc-bmi vital-input"
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="weight_badan" name="tanda_vital[weight_badan]"
                        class="form-control calc-bmi vital-input"
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="tanda_vital[spo2]" class="form-control vital-input"
...
</div> {{-- Tutup div #vital-signs-container --}}
