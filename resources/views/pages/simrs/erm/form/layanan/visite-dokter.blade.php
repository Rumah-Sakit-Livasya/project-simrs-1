        ...
        <div class="tab-content p-3">
            <div class="tab-pane fade show active" id="tab_default-1" role="tabpanel">
                ...
                <header class="text-primary text-center font-weight-bold mb-4">
                    ...
                    <h2 class="font-weight-bold">Visite Dokter</h2>
                </header>
...
@section('plugin-erm')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Tidak ditemukan elemen loading-overlay pada modal ini, jadi abaikan
            ...
            modalTambahVisite.on('show.bs.modal', function() {
                ...
                $('#form-tambah-visite select').val('').trigger('change');
            ...
            $('#form-tambah-visite').on('submit', function(event) {
                ...
                button.contents().last()[0].textContent = " Menyimpan...";
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        if (typeof showErrorAlertNotRefresh === 'function') {
                    ...
                    complete: function() {
                        button.prop("disabled", false).find(".spinner-border").addClass(
                            "d-none");
                        button.contents().last()[0].textContent = " Simpan";
                    }
                });
            });
