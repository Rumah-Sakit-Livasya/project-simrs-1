                   ...
                   <div class="panel-content">
                       ...
                       <form action="{{ route('radiologi.template.tambah') }}" method="POST">
                           ...
                           <div class="row justify-content-end mt-3">
                               <div class="col-xl-3">
                                   <button class="btn btn-primary waves-effect waves-themed" id="tambah-btn" data-toggle="modal"
                                       data-target="#tambahTemplateModal">
                                       <span class="fal fa-plus mr-1"></span>
                                       Tambah
                                   </button>

                                   <div class="modal fade" id="tambahTemplateModal" tabindex="-1"
