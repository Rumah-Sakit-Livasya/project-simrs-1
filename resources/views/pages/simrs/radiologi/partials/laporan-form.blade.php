   ...
   <script>
       function showReport(event) {
           ...
           const group_parameter = form.querySelector('select[name="group_parameter"]').value || '-';
           const penjamin = form.querySelector('select[name="penjamin"]').value || '-';
           const radiografer = form.querySelector('select[name="radiografer"]').value || '-';

           const src =
               `/simrs/radiologi/laporan-view/${startDate}/${endDate}/${tipe_rawat}/${group_parameter}/${penjamin}/${radiografer}/`;
