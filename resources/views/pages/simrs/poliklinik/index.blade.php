                    ...
                    <div class="tab-content p-3">
                        <div class="tab-pane fade show active" id="tab_default-1" role="tabpanel">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="penurunan_bb" class="control-label text-primary">Penurunan berat badan
                                            6
                                            bln
                                            terakhir</label>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="form-group">
                                        <label for="no_kontak_kerabat" class="control-label text-primary">Kontak kerabat
                                            yang
                                            dapat
                                            dihubungi</label>
                                            ...
                                            <td>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input name="sensorik_pendengaran" id="sensorik_pendengaran2"
                                                        ...
                                                        class="custom-control-input" type="radio">
                                                    <label class="custom-control-label" for="sensorik_pendengaran2">Tuli
                                                        Ka
                                                        /
                                                        Ki</label>
                                                </div>
                                            ...
                                            <td colspan="2">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input name="sensorik_pendengaran" id="sensorik_pendengaran3"
                                                        ...
                                                        class="custom-control-input" type="radio">
                                                    <label class="custom-control-label" for="sensorik_pendengaran3">Ada
                                                        alat
