    ...
    $(document).ready(function() {
        ...
        function get_bmi_pd() {
            ...
            if (pdA !== '' && pdB !== '') {
                ...
                $('#pengkajian-dokter-rajal-form #bmi, #pengkajian-dokter-rajal-form #kat_bmi').addClass('dirty');
            } else {
                // Reset nilai jika input tidak valid
                $('#pengkajian-dokter-rajal-form #bmi').val('');
                $('#pengkajian-dokter-rajal-form #kat_bmi').val('');
                $('#pengkajian-dokter-rajal-form #bmi, #pengkajian-dokter-rajal-form #kat_bmi').removeClass('dirty');
            }
        }
