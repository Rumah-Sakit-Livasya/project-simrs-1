                ...
                <div class="tab-content p-3">
                    <div class="tab-pane fade show active" id="tab_default-1" role="tabpanel">
                        <form action="javascript:void(0)" id="transfer_pasien_antar_ruangan">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group">
                                                <input id="dokter2" type="text" name="dokter2"
                                                    class="form-control"">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <i class="fas fa-user-md"></i>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group">
                                                <input id="dokter3" type="text" name="dokter3"
                                                    class="form-control"">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <i class="fas fa-user-md"></i>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="kondisi_pasien" id="kondisi_pasien2"
                                                            value="Memburuk" type="radio" class="custom-control-input">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="tindakan" id="tindakan1" value="OK"
                                                            type="radio" class="custom-control-input">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="tindakan" id="tindakan2" value="VK"
                                                            type="radio" class="custom-control-input">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <label for="keadaan_umum" class="control-label text-primary mt-3">Keadaan
                                        Umum:</label>
                                    <div class="row mt-3">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="keadaan_umum_gcs" id="keadaan_umum_gcs"
                                                            value="GCS" type="radio" class="custom-control-input">
                                ...
                                <div class="col-md-6" style="margin-top: 3rem;">
                                    ...
                                    <div class="form-group">
                                        <label for="status_nyeri" class="control-label text-primary">Status Nyeri:
                                        </label>
                                                ...
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline"
                                                        ...
                                                        <input name="mpp" id="jalan_gendong" value="Jalan/Gendong"
                                                            type="radio" class="custom-control-input">
                                                        <span
                                                            class="custom-control-label text-primary">Jalan/Gendong</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="rj" id="rj_tidak_berisiko"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline"
                                                        for="rj_rendah">
                                                        <input name="rj" id="rj_rendah" value="Rendah"
                                                            type="radio" class="custom-control-input">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="rj" id="rj_tinggi" value="Tinggi"
                                                            type="radio" class="custom-control-input">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="kti" id="kti_kontak" value="Kontak"
                                                            type="radio" class="custom-control-input">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="kti" id="kti_udara" value="Udara"
                                                            type="radio" class="custom-control-input">
                                    ...
                                    <label for="kondisi_khusus1" class="control-label text-primary mt-3">Memerlukan
                                        perawatan
                                        isolasi:
                                    </label>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="mpi" id="mpi_ya" value="Ya"
                                                            type="radio" class="custom-control-input">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="mpi" id="mpi_tidak" value="Tidak"
                                                            type="radio" class="custom-control-input">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="input-group">
                                                <input class="form-control numeric calc-bmi" id="pmp_text"
                                                    name="pmp_text" type="text">
                                                <div class="input-group-append">
                                                ...
                                                <div class="form-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input name="pmp_cateter_urine" id="pmp_cateter_urine"
                                                            ...
                                                            class="custom-control-input">
                                                        <span class="custom-control-label text-primary">Cateter
                                                            urine</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <div class="form-group">
                                                <div class="form-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline"
                                                        for="pmp_ngt">
                                                        <input name="pmp_ngt" id="pmp_ngt" value="pmp_ngt"
                                                            type="checkbox" class="custom-control-input">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline">
                                                        <input name="ap" id="ap_ya" value="ap_ya"
                                                            type="radio" class="custom-control-input">
                                                        <span class="custom-control-label text-primary">Ya</span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-radio">
                                                    <label class="custom-control custom-radio custom-control-inline"
                                                        for="ap_tidak">
                                                        <input name="ap" id="ap_tidak" value="ap_tidak"
                                                            type="radio" class="custom-control-input">
                                                        <span class="custom-control-label text-primary">Tidak</span>
                                                    </label>
                                                </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            <label for="sfp_mandiri" class="control-label text-primary mt-3">Status
                                                fungsional
                                                pasien:</label>
                                            <div class="row">
                                                <div class="col-md-4">
                                                        ...
                                                        <div class="form-radio">
                                                            <label
                                                                ...
                                                                <input name="sfp" id="sfp_mandiri" value="Mandiri"
                                                                    type="radio" class="custom-control-input">
                                                                <span
                                                                    class="custom-control-label text-primary">Mandiri</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-radio">
                                                            <label
                                                                class="custom-control custom-radio custom-control-inline"
                                                                for="sfp_total_care">
                                                                <input name="sfp" id="sfp_total_care"
                                                                    value="Total care" type="radio"
                                                                    class="custom-control-input">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="ptsp_infus_tetesan"
                                                    class="control-label text-primary">Tetesan:
                                                </label>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="diet_after" type="text" name="diet_after"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
