                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="nama_pasien" name="nama_pasien" type="text"
                                                placeholder="Nama Pasien" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label" for="tgl_lahir">Tanggal Lahir</label>
                                            <input id="tgl_lahir" name="tgl_lahir" type="text"
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="checkbox">
                                        <label for="penggunaan_obat-0">
                                            <input type="checkbox" name="penggunaan_obat" id="penggunaan_obat-0"
                                                value="1" class="a">
                                    ...
                                    <div class="checkbox">
                                        <label for="penggunaan_obat-1">
                                            <input type="checkbox" name="penggunaan_obat" id="penggunaan_obat-1"
                                                value="2" class="a">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody class="form-group">
                                        <tr>
                                            <td>1</td>
                                            <td><input id="kolom1" name="kolom1" type="text"
                                                    placeholder="Nama Obat" class="form-control reset"></td>
                                            <td><input id="kolom1a" name="kolom1a" type="text" placeholder="Dosis"
                                                    class="form-control reset"></td>
                                            <td><input id="kolom1b" name="kolom1b" type="text"
                                                    placeholder="Cara Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom1c" name="kolom1c" type="text"
                                                    placeholder="Waktu Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom1d" name="kolom1d" type="text"
                                                    placeholder="Lama Pemberian" class="form-control reset"></td>
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom1e-0">
                                                        <input type="checkbox" name="kolom1e" id="kolom1e-0"
                                                            value="1" class="a">
                                                        Admisi
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom1f-1">
                                                        <input type="checkbox" name="kolom1f" id="kolom1f-1"
                                                            value="2" class="a">
                                                        Discharge
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom1g-1">
                                                        <input type="checkbox" name="kolom1g" id="kolom1g-1"
                                                            value="3" class="a">
                                                        Transfer
                                                    </label>
                                                </div>
                                            ...
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom1h-0">
                                                        <input type="checkbox" name="kolom1h" id="kolom1h-0"
                                                            value="1" class="a">
                                                ...
                                                <div class="checkbox">
                                                    <label for="kolom1i-1">
                                                        <input type="checkbox" name="kolom1i" id="kolom1i-1"
                                                            value="2" class="a">
                                                ...
                                                <div class="checkbox">
                                                    <label for="kolom1j-2">
                                                        <input type="checkbox" name="kolom1j" id="kolom1j-2"
                                                            value="3" class="a">
                                                        STOP
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom1k-3">
                                                        <input type="checkbox" name="kolom1k" id="kolom1k-3"
                                                            value="4" class="a">
                                                        Obat Baru
                                                    </label>
                                                </div>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td><input id="kolom2" name="kolom2" type="text"
                                                    placeholder="Nama Obat" class="form-control reset"></td>
                                            <td><input id="kolom2a" name="kolom2a" type="text" placeholder="Dosis"
                                                    class="form-control reset"></td>
                                            <td><input id="kolom2b" name="kolom2b" type="text"
                                                    placeholder="Cara Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom2c" name="kolom2c" type="text"
                                                    placeholder="Waktu Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom2d" name="kolom2d" type="text"
                                                    placeholder="Lama Pemberian" class="form-control reset"></td>
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom2e-0">
                                                        <input type="checkbox" name="kolom2e" id="kolom2e-0"
                                                            value="1" class="a">
                                                        Admisi
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom2f-1">
                                                        <input type="checkbox" name="kolom2f" id="kolom2f-1"
                                                            value="2" class="a">
                                                        Discharge
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom2g-1">
                                                        <input type="checkbox" name="kolom2g" id="kolom2g-1"
                                                            value="3" class="a">
                                                        Transfer
                                                    </label>
                                                </div>
                                            ...
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom2h-0">
                                                        <input type="checkbox" name="kolom2h" id="kolom2h-0"
                                                            value="1" class="a">
                                                        Lanjut aturan pakai sama
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom2i-1">
                                                        <input type="checkbox" name="kolom2i" id="kolom2i-1"
                                                            value="2" class="a">
                                                        Lanjut aturan pakai berubah
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom2j-2">
                                                        <input type="checkbox" name="kolom2j" id="kolom2j-2"
                                                            value="3" class="a">
                                                        STOP
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom2k-3">
                                                        <input type="checkbox" name="kolom2k" id="kolom2k-3"
                                                            value="4" class="a">
                                                        Obat Baru
                                                    </label>
                                                </div>
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td><input id="kolom3" name="kolom3" type="text"
                                                    placeholder="Nama Obat" class="form-control reset"></td>
                                            <td><input id="kolom3a" name="kolom3a" type="text" placeholder="Dosis"
                                                    class="form-control reset"></td>
                                            <td><input id="kolom3b" name="kolom3b" type="text"
                                                    placeholder="Cara Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom3c" name="kolom3c" type="text"
                                                    placeholder="Waktu Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom3d" name="kolom3d" type="text"
                                                    placeholder="Lama Pemberian" class="form-control reset"></td>
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom3e-0">
                                                        <input type="checkbox" name="kolom3e" id="kolom3e-0"
                                                            value="1" class="a">
                                                        Admisi
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom3f-1">
                                                        <input type="checkbox" name="kolom3f" id="kolom3f-1"
                                                            value="2" class="a">
                                                        Discharge
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom3g-1">
                                                        <input type="checkbox" name="kolom3g" id="kolom3g-1"
                                                            value="3" class="a">
                                                        Transfer
                                                    </label>
                                                </div>
                                            ...
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom3h-0">
                                                        <input type="checkbox" name="kolom3h" id="kolom3h-0"
                                                            value="1" class="a">
                                                        Lanjut aturan pakai sama
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom3i-1">
                                                        <input type="checkbox" name="kolom3i" id="kolom3i-1"
                                                            value="2" class="a">
                                                        Lanjut aturan pakai berubah
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom3j-2">
                                                        <input type="checkbox" name="kolom3j" id="kolom3j-2"
                                                            value="3" class="a">
                                                        STOP
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom3k-3">
                                                        <input type="checkbox" name="kolom3k" id="kolom3k-3"
                                                            value="4" class="a">
                                                        Obat Baru
                                                    </label>
                                                </div>
                                        ...
                                        <tr>
                                            <td>4</td>
                                            <td><input id="kolom4" name="kolom4" type="text"
                                                    placeholder="Nama Obat" class="form-control reset"></td>
                                            <td><input id="kolom4a" name="kolom4a" type="text" placeholder="Dosis"
                                                    class="form-control reset"></td>
                                            <td><input id="kolom4b" name="kolom4b" type="text"
                                                    placeholder="Cara Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom4c" name="kolom4c" type="text"
                                                    placeholder="Waktu Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom4d" name="kolom4d" type="text"
                                                    placeholder="Lama Pemberian" class="form-control reset"></td>
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom4e-0">
                                                        <input type="checkbox" name="kolom4e" id="kolom4e-0"
                                                            value="1" class="a">
                                                        Admisi
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom4f-1">
                                                        <input type="checkbox" name="kolom4f" id="kolom4f-1"
                                                            value="2" class="a">
                                                        Discharge
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom4g-1">
                                                        <input type="checkbox" name="kolom4g" id="kolom4g-1"
                                                            value="3" class="a">
                                                        Transfer
                                                    </label>
                                                </div>
                                            ...
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom4h-0">
                                                        <input type="checkbox" name="kolom4h" id="kolom4h-0"
                                                            value="1" class="a">
                                                        Lanjut aturan pakai sama
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom4i-1">
                                                        <input type="checkbox" name="kolom4i" id="kolom4i-1"
                                                            value="2" class="a">
                                                        Lanjut aturan pakai berubah
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom4j-2">
                                                        <input type="checkbox" name="kolom4j" id="kolom4j-2"
                                                            value="3" class="a">
                                                        STOP
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom4k-3">
                                                        <input type="checkbox" name="kolom4k" id="kolom4k-3"
                                                            value="4" class="a">
                                                        Obat Baru
                                                    </label>
                                                </div>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td><input id="kolom5" name="kolom5" type="text"
                                                    placeholder="Nama Obat" class="form-control reset"></td>
                                            <td><input id="kolom5a" name="kolom5a" type="text" placeholder="Dosis"
                                                    class="form-control reset"></td>
                                            <td><input id="kolom5b" name="kolom5b" type="text"
                                                    placeholder="Cara Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom5c" name="kolom5c" type="text"
                                                    placeholder="Waktu Pemberian" class="form-control reset"></td>
                                            <td><input id="kolom5d" name="kolom5d" type="text"
                                                    placeholder="Lama Pemberian" class="form-control reset"></td>
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom5e-0">
                                                        <input type="checkbox" name="kolom5e" id="kolom5e-0"
                                                            value="1" class="a">
                                                        Admisi
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom5f-1">
                                                        <input type="checkbox" name="kolom5f" id="kolom5f-1"
                                                            value="2" class="a">
                                                        Discharge
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom5g-1">
                                                        <input type="checkbox" name="kolom5g" id="kolom5g-1"
                                                            value="3" class="a">
                                                        Transfer
                                                    </label>
                                                </div>
                                            ...
                                            <td>
                                                <div class="checkbox">
                                                    <label for="kolom5h-0">
                                                        <input type="checkbox" name="kolom5h" id="kolom5h-0"
                                                            value="1" class="a">
                                                        Lanjut aturan pakai sama
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom5i-1">
                                                        <input type="checkbox" name="kolom5i" id="kolom5i-1"
                                                            value="2" class="a">
                                                        Lanjut aturan pakai berubah
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom5j-2">
                                                        <input type="checkbox" name="kolom5j" id="kolom5j-2"
                                                            value="3" class="a">
                                                        STOP
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label for="kolom5k-3">
                                                        <input type="checkbox" name="kolom5k" id="kolom5k-3"
                                                            value="4" class="a">
                                                        Obat Baru
                                                    </label>
                                                </div>
                                    ...
                                    <tbody class="form-group">
                                        <tr>
                                            ...
                                            <td>
                                                <select name="kolom7a" size="1" id="kolom7a"
                                                    class="sel2 select2-hidden-accessible" tabindex="-1"
                                                    aria-hidden="true">
                                                    <option></option>
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom7a-container"><span
                                                                ...
                                                                id="select2-kolom7a-container" title=""></span><span
                                                ...
                                                <select name="kolom7b" size="1" id="kolom7b"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom7b-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom7b-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom7c" size="1" id="kolom7c"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom7c-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom7c-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom7d" size="1" id="kolom7d"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom7d-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom7d-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom7e" size="1" id="kolom7e"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom7e-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom7e-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom7f" size="1" id="kolom7f"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom7f-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom7f-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom7g" size="1" id="kolom7g"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom7g-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom7g-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom8a" size="1" id="kolom8a"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom8a-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom8a-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom8b" size="1" id="kolom8b"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom8b-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom8b-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom8c" size="1" id="kolom8c"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom8c-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom8c-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom8d" size="1" id="kolom8d"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom8d-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom8d-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                ...
                                                <select name="kolom8e" size="1" id="kolom8e"
                                                    ...
                                                    dir="ltr" style="width: 254px;"><span class="selection"><span
                                                            ...
                                                            aria-labelledby="select2-kolom8e-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-kolom8e-container" title=""></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                                                                    role="presentation"></b></span></span></span><span
                                                        class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        ...
                                        <tr>
                                            <td><input id="kolom9" name="kolom9" type="text"
                                                    class="form-control datepicker reset"
