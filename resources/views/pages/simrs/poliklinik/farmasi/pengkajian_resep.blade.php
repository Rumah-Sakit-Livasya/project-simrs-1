                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input type="radio" name="sip" value="f"
                                                    id="check_cara"></td>
                                            <td align="center"><input type="text" name="keterangan_sip"
                                                    style="width: 300px;" value="" id="check_cara"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input type="radio" name="pio" value="f"
                                                    id="check_cara"></td>
                                            <td align="center"><input type="text" name="keterangan_pio"
                                                    style="width: 300px;" value="" id="check_cara"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input type="radio" name="pto" value="f"
                                                    id="check_cara"></td>
                                            <td align="center"><input type="text" name="keterangan_pto"
                                                    style="width: 300px;" value="" id="check_cara"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input type="radio" name="epo" value="f"
                                                    id="check_cara"></td>
                                            <td align="center"><input type="text" name="keterangan_epo"
                                                    style="width: 300px;" value="" id="check_cara"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">Dispensing sediaan steril</td>
                                            <td align="center"><input type="radio" name="dispensing_sediaan"
                                                    value="t" id="check_cara"></td>
                                            <td align="center"><input type="radio" name="dispensing_sediaan"
                                                    value="f" id="check_cara"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input type="radio" name="benar_obat" value="f"
                                                    id="check_cara"></td>
                                            <td align="center"><input type="text" name="ket_benar_obat"
                                                    style="width: 300px;" value="" id="check_cara"></td>
                                        </tr>
                                        <tr>
