...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        <form autocomplete="off" action="{{ route('master.data.setup.simpan.tambah.departement') }}" method="post">
            @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-2" style="text-align: left">
                                                    <label for="Publish Online" class="form-label">Publish Online *</label>
                                                </div>
                                                <div class="col-sm-10">
                                                    <input type="checkbox"
