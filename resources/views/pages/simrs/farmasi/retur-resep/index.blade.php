@extends('inc.layout')
@section('title', 'List Retur Resep')
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        @include('pages.simrs.farmasi.retur-resep.partials.index-form')

        @include('pages.simrs.farmasi.retur-resep.partials.index-datatable')
    </main>
@endsection
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/farmasi/retur-resep/index.js') }}?v={{ time() }}"></script>
