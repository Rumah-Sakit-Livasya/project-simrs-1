                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            {{-- <form action="{{ route('farmasi.transaksi-resep.popup.telaah-resep') }}" method="post"> --}}
                            <form id="form" action="#" method="post">
                                @method('post')
                                @csrf

                                <div class="row justify-content-center">
                                    <table class="w-100 table-bordered table-bordered table-hover table-striped bg-white border border-gray-200"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-2 px-4 border-b text-center">
                                                    <input type="radio" required name="benar_pasien" value="1"
                                                        required
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-2 px-4 border-b text-center">
                                                    <input type="radio" required name="benar_dosis" value="1"
                                                        required
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-2 px-4 border-b text-center">
                                                    <input type="radio" required
                                                        name="benar_waktu_dan_frekeunsi_pemberian" required
                                                        {{ isset($telaah) && $telaah?->benar_waktu_dan_frekeunsi_pemberian == 1 ? 'checked' : '' }}
                                                        value="1" class="form-control">
                                                </td>
                                                <td class="py-2 px-4 border-b text-center">
                                                    <input type="radio" required
                                                        name="benar_waktu_dan_frekeunsi_pemberian"
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-2 px-4 border-b text-center">
                                                    <input type="radio" required name="ada_duplikat_obat"
                                                        value="1"
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-2 px-4 border-b text-center">
                                                    <input type="radio" required
                                                        name="interaksi_obat_yang_mungkin_terjadi"
