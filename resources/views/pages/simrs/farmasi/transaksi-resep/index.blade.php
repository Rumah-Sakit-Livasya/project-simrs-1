@extends('inc.layout')
@section('title', 'List Transaksi Resep')
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        @include('pages.simrs.farmasi.transaksi-resep.partials.index-form')

        @include('pages.simrs.farmasi.transaksi-resep.partials.index-datatable')
    </main>
@endsection
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/farmasi/transaksi-resep/index.js') }}?v={{ time() }}"></script>
