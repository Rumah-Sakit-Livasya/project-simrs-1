...
@section('content')
    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        @include('pages.simrs.farmasi.report.partials.stock-status-form')

        @include('pages.simrs.farmasi.report.partials.stock-status-datatable')
    </main>
@endsection
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/farmasi/revaluasi-stock/stock-opname/report/stock-status.js') }}?v={{ time() }}">
    </script>
