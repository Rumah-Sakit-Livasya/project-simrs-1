@extends('inc.layout')
@section('title', 'List Resep Response')
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        @include('pages.simrs.farmasi.resep-response.partials.index-form')

        @include('pages.simrs.farmasi.resep-response.partials.index-datatable')
    </main>
@endsection
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/farmasi/resep-response/index.js') }}?v={{ time() }}"></script>
