...
<body>
    ...
    <script type="text/javascript">
        function detail_penjualan(tgl, mbid) {
            popupwindow('http://192.168.1.253/testing/warehouse/print_penjualan_pertgl/' + tgl + '/' + mbid + '/tanggal/' +
                pid_dokter, 'popup_detail_penjualan', '950', '600', '');
        }
    </script>
