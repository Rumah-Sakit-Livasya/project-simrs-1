            ...
            <tbody>
                ...
                @foreach ($reseps as $resep)
                    @php
                        ...
                        $doctor = '';
                        if (isset($resep->doctor_id)) {
                            $doctor = $resep->doctor->employee->name;
                        } else {
                            $doctor = $resep->registration->doctor->employee->name;
                        }
                    @endphp
                    <tr>
                    ...
                    @foreach ($resep->items as $item)
                        @if (!isset($item->racikan_id) && $item->tipe == 'obat')
                            ...
                            <tr>
                                ...
                                <td align="right">{{ rp($item->subtotal - $item->embalase) }}</td>
                            </tr>
                        @endif
                    @endforeach
