<div class="row justify-content-center">
    <div class="col-xl-8">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Form <span class="fw-300"><i>Pencarian Klaim Kronis</i></span>
                </h2>
            </div>
...
<script>
    function showReport(event) {
        ...
        const src =
            `/simrs/farmasi/laporan/klaim-kronis/view/${startDate}/${endDate}/${tipe}/${doctor_id}/${departement_id}/${kelas_rawat_id}/${nama_obat}`;
