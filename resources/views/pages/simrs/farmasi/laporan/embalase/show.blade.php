                        ...
                        @if ($item->embalase > 0)
                            @php
                                ...
                                if ($isOTC) {
                                    ...
                                    $no_reg = $resep->otc->registration_number;
                                } else {
                                    $nama = $resep->registration->patient->name;
                                    $no_reg = $resep->registration->registration_number;
                                }
                            @endphp
                            <tr>
                                <td>{{ tgl_waktu($resep->created_at) }}</td>
                                <td>{{ $nama }} {{ $isOTC ? '[OTC]' : '' }}</td>
                                <td>{{ $no_reg }}</td>
                                <td>
                                ...
                                <td>{{ $item->tipe == 'racikan' ? 'RACIKAN' : $item->stored->pbi->nama_barang }}</td>
