...
@section('content')
    ...
    @include('pages.simrs.master-data.grup-suplier.partials.create')
    @include('pages.simrs.master-data.grup-suplier.partials.edit')
@endsection
@section('plugin')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-tambah-grup-suplier').click(function() {
                $('#modal-tambah-grup-suplier').modal('show');
            });

            $('.btn-edit').click(function() {
                console.log('clicked');
                $('#modal-edit-grup-suplier').modal('show');
                grupSuplierId = $(this).attr('data-id');
                $('#modal-edit-grup-suplier form').attr('data-id', grupSuplierId);

                $.ajax({
                    url: '/api/simrs/master-data/grup-suplier/' +
                        grupSuplierId,
                    type: 'GET',
                    success: function(response) {
                        $('#modal-edit-grup-suplier input[name="kategori"]').val(response
                            .kategori);
                        $('#modal-edit-grup-suplier input[name="status"][value="' +
                                response
                                .status + '"]')
                            .prop(
                                'checked', true);
                        $('#modal-edit-grup-suplier input[name="coa_utang"]').val(response
                            .coa_utang);
                    },
                    error: function(xhr, status, error) {
                        $('#modal-edit-grup-suplier').modal('hide');
            ...
            $('#store-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#modal-tambah-grup-suplier').modal('hide');
                        showSuccessAlert(response.message);
