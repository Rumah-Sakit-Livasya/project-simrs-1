<div class="modal fade" id="modal-edit-grup-suplier" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            <form autocomplete="off" novalidate action="javascript:void(0)" method="post" id="update-form">
                ...
                <div class="modal-header pb-1 mb-0">
                    <h5 class="modal-title font-weight-bold">Edit Grup Suplier</h5>
                ...
                <div class="modal-body py-2 row">
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="form-group">
                            <label for="grup-suplier">Kategori <span class="text-danger fw-bold">*</span>
                            </label>
                            <input type="text" class="form-control" id="grup-suplier" name="kategori">
                        </div>
                    </div>
                    <div class="col-md-12 mt-3">
                        <div class="form-group">
                            ...
                            <div class="custom-control d-inline-block custom-radio mt-2 mr-2">
                                <input type="radio" checked="" class="custom-control-input" id="status_aktif"
                                    name="status" value=1>
                                <label class="custom-control-label" for="status_aktif">Aktif</label>
                            </div>
                            <div class="custom-control d-inline-block custom-radio mt-2">
                                <input type="radio" class="custom-control-input" id="status_tidak" name="status"
                                    value=0>
