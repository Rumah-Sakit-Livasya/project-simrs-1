                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" name="is_aktif" class="custom-control-input"
                                            id="is_aktif_ya" value=1>
                                        <label class="custom-control-label" for="is_aktif_ya">Ya</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" value=0 class="custom-control-input" name="is_aktif"
                                            id="is_aktif_tidak" checked="">
                                        <label class="custom-control-label" for="is_aktif_tidak">Tidak</label>
                                    </div>
                                </div>
                            </div>
                        </div>
