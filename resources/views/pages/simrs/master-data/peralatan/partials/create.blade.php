<div class="modal fade" id="modal-tambah-peralatan" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            <form autocomplete="off" novalidate action="javascript:void(0)" method="post" id="store-form">
                ...
                <div class="modal-header pb-1 mb-0">
                    <h5 class="modal-title font-weight-bold">Tambah Peralatan</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" value=0 class="custom-control-input" name="is_req_dokter"
                                            id="is_req_dokter_tidak_tambah" checked="">
