<div class="modal fade" id="modal-tambah-tarif-registrasi" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            <form autocomplete="off" novalidate action="javascript:void(0)" method="post" id="store-form">
                ...
                <div class="modal-header pb-1 mb-0">
                    <h5 class="modal-title font-weight-bold">Tambah Tarif Registrasi</h5>
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <label for="nama_tarif">Nama Tarif <span
                                            class="text-danger fw-bold">*</span></label>
                                    <input type="text" value="{{ old('nama_tarif') }}" class="form-control"
                                        name="nama_tarif" placeholder="Masukan tarif registrasi...">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <label for="tipe">Tipe <span class="help-block text-danger">*</span></label>
                                    <select class="form-control w-100" id="tipe_edit" name="tipe">
                                        <option value="Semua Pasien">Semua Pasien</option>
