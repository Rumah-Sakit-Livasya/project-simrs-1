<div class="modal fade" id="modal-tambah-room" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document"> <!-- Menggunakan kelas modal-xl untuk ukuran ekstra besar -->
        <div class="modal-content">
            <form autocomplete="off" novalidate action="javascript:void(0)" method="post" id="store-form">
                @method('post')
                @csrf
                <input type="hidden" class="form-control" value="{{ $kelas_rawat->id }}" name="kelas_rawat_id"
                    id="kelas_rawat_id">
