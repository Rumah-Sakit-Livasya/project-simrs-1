<div class="modal fade" id="modal-tambah-kelas" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <label for="kelas">Kelas <span class="text-danger fw-bold">*</span></label>
                                    <input type="text" class="form-control" name="kelas"
                                        placeholder="Masukan nama kelas rawat...">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <label for="urutan">Urutan <span class="text-danger fw-bold">*</span>
                                    </label>
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    <label class="d-block">Is HCU ?</label>
                                    <div class="custom-control d-inline-block custom-radio mt-2 mr-2">
                                        <input type="radio" class="custom-control-input" id="is_hcu_aktif"
                                            name="is_hcu" value="1">
                                        <label class="custom-control-label" for="is_hcu_aktif">Ya</label>
                                    </div>
                                    <div class="custom-control d-inline-block custom-radio mt-2">
                                        <input type="radio" class="custom-control-input" id="is_hcu_tidak"
                                            name="is_hcu" checked="" value="0">
                                        <label class="custom-control-label" for="is_hcu_tidak">Tidak</label>
                                    </div>
                                </div>
                            </div>
