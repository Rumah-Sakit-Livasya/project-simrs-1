                            ...
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control d-inline-block custom-radio mt-2 mr-2">
                                        <input type="radio" class="custom-control-input" id="isICU_aktif"
                                            name="isICU" value="1">
                                        <label class="custom-control-label" for="isICU_aktif">Ya</label>
                                    </div>
                                    <div class="custom-control d-inline-block custom-radio mt-2">
                                        <input type="radio" class="custom-control-input" id="isICU_tidak"
                                            name="isICU" value="0">
                                        <label class="custom-control-label" for="isICU_tidak">Tidak</label>
                                    </div>
                                </div>
                            </div>
