<div class="modal fade" id="modal-tambah-bed" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document"> <!-- Menggunakan kelas modal-xl untuk ukuran ekstra besar -->
        <div class="modal-content">
            <form autocomplete="off" novalidate action="javascript:void(0)" method="post" id="store-form">
                @method('post')
                @csrf
                <input type="hidden" class="form-control" value="{{ $room->id }}" name="room_id"
                    id="kelas_rawat_id">
                <div class="modal-header pb-1 mb-0">
                    <h5 class="modal-title font-weight-bold">Tambah Ruangan</h5>
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_tt"
