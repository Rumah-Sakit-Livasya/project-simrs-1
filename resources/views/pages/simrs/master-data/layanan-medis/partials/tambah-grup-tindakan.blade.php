<div class="modal fade" id="modal-tambah-grup-tindakan" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control d-inline-block custom-radio mt-2 mr-2">
                                        <input type="radio" class="custom-control-input" id="Aktif" name="status"
                                            checked="" value="1">
                                        <label class="custom-control-label" for="Aktif">Aktif</label>
                                    </div>
                                    <div class="custom-control d-inline-block custom-radio mt-2">
                                        <input type="radio" class="custom-control-input" id="Tidak" name="status"
                                            value="0">
