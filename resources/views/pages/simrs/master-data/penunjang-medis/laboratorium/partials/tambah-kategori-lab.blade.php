<div class="modal fade" id="modal-tambah-kategori-laboratorium" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            <form autocomplete="off" novalidate action="javascript:void(0)" method="post" id="store-form">
                ...
                <div class="modal-header pb-1 mb-0">
                    <h5 class="modal-title font-weight-bold">Tambah Kategori Laboratorium</h5>
