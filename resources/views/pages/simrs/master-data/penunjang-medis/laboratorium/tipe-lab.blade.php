...
@section('content')
                        ...
                        <div class="panel-content">
                            ...
                            <div class="table-responsive">
                                <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                    ...
                                    <tbody>
                                        @foreach ($tipe_laboratorium as $row)
                                            <tr>
                                                <td>{{ $row->nama_tipe }}</td>
                                                <td>{{ $row->status }}</td>
                                                <td>
                                        ...
                                        <tr>
                                            <th colspan="3" class="text-center">
                                                <button type="button"
                                                    ...
                                                    id="btn-tambah-tipe-laboratorium">
                                                    <span class="fal fa-plus-circle"></span>
                                                    Tambah Tipe Laboratorium
                                                </button>
                                            </th>
                                        </tr>
                                    </tfoot>
    ...
    @include('pages.simrs.master-data.penunjang-medis.laboratorium.partials.tambah-tipe-lab')
    @include('pages.simrs.master-data.penunjang-medis.laboratorium.partials.edit-tipe-lab')
@endsection
@section('plugin')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-tambah-tipe-laboratorium').click(function() {
                $('#modal-tambah-tipe-laboratorium').modal('show');
            });

            $('#modal-tambah-tipe-laboratorium .select2').select2({
                dropdownParent: $('#modal-tambah-tipe-laboratorium')
            });
            ...
            $('.btn-edit').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#modal-edit-tipe-laboratorium input[name="nama_tipe"]')
                            .val(
                                response
                                .nama_tipe);
                        $('#modal-edit-tipe-laboratorium input[name="status"][value="' +
                                response
                                .status + '"]')
                            .prop(
                                'checked', true);
                    ...
                    error: function(xhr, status, error) {
                        $('#modal-edit-tipe-laboratorium').modal('hide');
            ...
            $('#store-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#modal-tambah-tipe-laboratorium').modal('hide');
                        showSuccessAlert(response.message);
