<div class="modal fade" id="modal-edit-kategori-radiologi" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            <form autocomplete="off" novalidate action="javascript:void(0)" method="post" id="update-form">
                ...
                <div class="modal-header pb-1 mb-0">
                    <h5 class="modal-title font-weight-bold">Edit Kategori Radiologi</h5>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control d-inline-block custom-radio mt-2 mr-2">
                                        <input type="radio" checked="" class="custom-control-input"
                                            id="status_aktif_edit" name="status" value="1">
                                        <label class="custom-control-label" for="status_aktif_edit">Aktif</label>
                                    </div>
                                    <div class="custom-control d-inline-block custom-radio mt-2">
                                        <input type="radio" class="custom-control-input" id="status_tidak_edit"
                                            name="status" value="0">
                                        <label class="custom-control-label" for="status_tidak_edit">Tidak</label>
                                    </div>
                                </div>
                            </div>
                        </div>
