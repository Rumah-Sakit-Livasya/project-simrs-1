                ...
                <div class="modal-body py-2 row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <label for="kategori_radiologi_id">Kategori Radiologi <span
                                            class="help-block text-danger">*</span></label>
                                    <select class="select2 form-control w-100" id="kategori_radiologi_id"
                                        name="kategori_radiologi_id">
                                        <option value=""></option>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="kode" placeholder="501">
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
