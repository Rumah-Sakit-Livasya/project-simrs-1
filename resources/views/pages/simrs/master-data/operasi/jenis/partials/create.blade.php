<div class="modal fade" id="modal-tambah-jenis" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            <form autocomplete="off" novalidate action="javascript:void(0)" method="post" id="store-form">
                ...
                <div class="modal-header pb-1 mb-0">
                    <h5 class="modal-title font-weight-bold">Tambah Jenis</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                <div class="form-group">
                                    <label for="jenis">Nama Jenis <span class="text-danger fw-bold">*</span>
                                    </label>
