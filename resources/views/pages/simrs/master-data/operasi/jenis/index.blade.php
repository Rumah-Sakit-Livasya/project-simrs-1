...
@section('content')
    ...
    @include('pages.simrs.master-data.operasi.jenis.partials.create')
    @include('pages.simrs.master-data.operasi.jenis.partials.edit')
@endsection
@section('plugin')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-edit').click(function() {
                ...
                jenisId = $(this).attr('data-id');
                $('#modal-edit-jenis form').attr('data-id', jenisId);

                $.ajax({
                    url: '/api/simrs/master-data/operasi/jenis/' +
                        jenisId,
                    type: 'GET',
                    success: function(response) {
                        $('#modal-edit-jenis input[name="jenis"]').val(response.jenis);
                    },
