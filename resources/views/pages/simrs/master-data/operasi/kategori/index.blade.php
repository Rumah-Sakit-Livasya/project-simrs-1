...
@section('content')
    ...
    @include('pages.simrs.master-data.operasi.kategori.partials.create')
    @include('pages.simrs.master-data.operasi.kategori.partials.edit')
@endsection
@section('plugin')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-edit').click(function() {
                ...
                $.ajax({
                    url: '/api/simrs/master-data/operasi/kategori/' +
                        kategoriId,
                    type: 'GET',
                    success: function(response) {
                        $('#modal-edit-kategori input[name="nama_kategori"]').val(response
                            .nama_kategori);
                        $('#modal-edit-kategori input[name="urutan"]').val(response.urutan);
                    },
