...
@section('content')
                                ...
                                <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                    ...
                                    <thead class="bg-primary-600">
                                        <tr>
                                            ...
                                            <th>Anestesi</th>
                                            <th>Resusitator</th>
                                            <th>Dokter Tambahan</th>
                                            <th>Alat</th>
                                            <th>Ruangan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($tipe_operasi as $row)
                                            <tr>
                                                <td style="vertical-align: middle">
                                                    {{ $row->tipe }}
                                                </td>
                                                <td>
                                                    <input type="text" width="100%" class="form-control" id="operator"
                                                        name="operator[{{ $row->id }}]" value="{{ $row->operator }}">
                                                </td>
                                                <td>
                                                    <input type="text" width="100%" class="form-control" id="anestesi"
                                                        name="anestesi[{{ $row->id }}]" value="{{ $row->anestesi }}">
                                                </td>
                                                <td>
                                                    <input type="text" width="100%" class="form-control"
                                                        id="resusitator" name="resusitator[{{ $row->id }}]"
                                                        value="{{ $row->resusitator }}">
                                                </td>
                                                <td>
                                                    <input type="text" width="100%" class="form-control"
                                                        id="dokter_tambahan" name="dokter_tambahan[{{ $row->id }}]"
                                                        value="{{ $row->dokter_tambahan }}">
                                                </td>
                                                <td>
                                                    <input type="text" width="100%" class="form-control" id="alat"
                                                        name="alat[{{ $row->id }}]" value="{{ $row->alat }}">
                                                </td>
                                                <td>
                                                    <input type="text" width="100%" class="form-control" id="ruangan"
                                                        name="ruangan[{{ $row->id }}]" value="{{ $row->ruangan }}">
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
    ...
    @include('pages.simrs.master-data.operasi.tipe.partials.create')
    @include('pages.simrs.master-data.operasi.tipe.partials.edit')
@endsection
@section('plugin')
