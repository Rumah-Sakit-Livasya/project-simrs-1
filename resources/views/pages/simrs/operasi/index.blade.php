                        ...
                        <div class="panel-content">
                            <form action="{{ route('ok.daftar-pasien') }}" method="get">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <<<<<<< HEAD=======>>>>>>> 6551efe52ce9293b08d2aa8c1be7aea103871e98
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <select class="form-control select2" id="status_registrasi"
                                                ...
                                                <option value="aktif"
                                                    {{ request('status_registrasi') == 'aktif' ? 'selected' : '' }}>
                                                    Registrasi
                                                    Aktif</option>
                                ...
                                Swal.fire({
                                            ...
                                            $('#dt-basic-example tbody').on('click', '.delete-order-btn', function(e) {
                                                    ...
                                                    var row = button.closest(
                                                        'tr'); // Dapatkan baris tabel untuk dihapus nanti
                                                    ...
                                                    Swal.fire({
                                                        ...
                                                        >>>
                                                        >>>
                                                        > 6551 efe52ce9293b08d2aa8c1be7aea103871e98
                                                        icon: 'warning',
                                                ...
                                                $('#btn-plasma-view').on('click', function() {
                                                    ...
                                                    // Buka pop-up window
                                                    window.open(url, 'PlasmaJadwalOperasi', 'width=' + width +
                                                        ',height=' + height + ',top=' +
                                                        top +
                                                        ',left=' + left + ',resizable=yes,scrollbars=yes');
                                                });
