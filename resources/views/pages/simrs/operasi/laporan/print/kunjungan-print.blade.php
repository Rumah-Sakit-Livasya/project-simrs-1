@extends('pages.simrs.operasi.laporan.template_print')

@section('title', 'Laporan Rekap Kunjungan OK')

@section('content')
    <div class="report-header">
        <div class="report-title">REKAP KUNJUNGAN OK BERDASARKAN TINDAKAN</div>
    </div>
    ...
    <table style="width: 50%; border: none; font-size: 10pt; margin-bottom: 20px;">
        <tbody>
            <tr style="border: none;">
                <td style="border: none; padding: 2px; width: 150px;">Tahun</td>
                <td style="border: none; padding: 2px;">: {{ $filters['year'] }}</td>
            </tr>
            <tr style="border: none;">
            ...
            <tr style="border: none;">
                <td style="border: none; padding: 2px;">Dokter</td>
                <td style="border: none; padding: 2px;">: {{ $filters['dokter'] }}</td>
            </tr>
            <tr style="border: none;">
                <td style="border: none; padding: 2px;">Tipe Operasi</td>
                <td style="border: none; padding: 2px;">: {{ $filters['jenis_operasi'] }}</td>
            </tr>
            <tr style="border: none;">
                <td style="border: none; padding: 2px;">Tipe Penggunaan</td>
                <td style="border: none; padding: 2px;">: {{ $filters['tipe_penggunaan'] }}</td>
            </tr>
            <tr style="border: none;">
