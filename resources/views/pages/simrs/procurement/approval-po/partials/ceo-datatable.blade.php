...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Daftar <span class="fw-300"><i>Approval PO (CEO)</i></span>
                </h2>
            </div>
                    ...
                    <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                        ...
                        <thead class="bg-primary-600">
                            <tr>
                                ...
                                <th>Tanggal PO</th>
                                <th>Tanggal APP</th>
                                <th>Tanggal APP CEO</th>
                                <th>Supplier</th>
                                <th>Keterangan PO</th>
                                <th>Keterangan APP</th>
                                <th>Keterangan APP CEO</th>
                                <th>User APP</th>
                                <th>Tipe PO</th>
                                <th>Nominal</th>
                                <th>Status</th>
                                    ...
                                    <td>
                                        @if ($po->approval_ceo == 'unreviewed')
                                            @php
                                                ...
                                                switch($po->getTable()){
                                                    case("procurement_purchase_order_non_pharmacy"):
                                                        $type = "np";
                                                        break;
                                                    case("procurement_purchase_order_pharmacy"):
                                                        $type = "p";
                                                        break;
                                                    default:
                                            ...
                                            <a class="mdi mdi-pencil pointer mdi-24px text-secondary edit-btn"
                                                title="Review" data-id="{{ $po->id }}" data-type="{{ $type }}"></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
