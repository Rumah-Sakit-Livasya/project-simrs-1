@extends('inc.layout')
@section('title', 'List Approval Purchase Order (Non Pharmacy)')
@section('content')
    <main id="js-page-content" role="main" class="page-content">

        @include('pages.simrs.procurement.approval-po.partials.non-pharmacy-form')

        @include('pages.simrs.procurement.approval-po.partials.non-pharmacy-datatable')
    </main>
@endsection
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/procurement/approval-po/non-pharmacy.js') }}?v={{ time() }}"></script>
