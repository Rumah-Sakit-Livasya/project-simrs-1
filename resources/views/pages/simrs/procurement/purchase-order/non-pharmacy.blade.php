@extends('inc.layout')
@section('title', 'List Purchase Order (Non Pharmacy)')
@section('content')
    <main id="js-page-content" role="main" class="page-content">

        @include('pages.simrs.procurement.purchase-order.partials.non-pharmacy-form')

        @include('pages.simrs.procurement.purchase-order.partials.non-pharmacy-datatable')
    </main>
@endsection
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/procurement/purchase-order/non-pharmacy.js') }}?v={{ time() }}"></script>
