...
<body>
    ...
    <div id="previews">
        ...
        <div id="lhd">
            <div class="lgo"><img src="{{ asset('/img/logo.png') }}" width="75"></div>
            <div class="ttl" style="margin-left:28px;">
                <span class="nme">Rumah Sakit Livasya</span>
                <span>Jl. Raya Timur III Dawuan No. 875 Kab. Majalengka Kab. Majalengka</span>
                <span>Phone. 081211151300</span>
            </div>
        </div>

        <h2 class="bdr">
            <span class="rgt"><span class="til">NO RETUR #</span><span>{{ $rb->kode_retur }}</span></span>
            Retur Barang
            <span>Tanggal : {{ tgl($rb->tanggal_retur) }}</span>
        </h2>

        <div id="hhr">
            <ul>
                <li><span>Supplier</span>: {{ $rb->supplier->nama }}</li>
                <li><span>Alamat</span>: {{ $rb->supplier->alamat }}</li>
                <li><span>Telp/Fax</span>: {{ $rb->supplier->phone }} / {{ $rb->supplier->fax ?? '-' }}</li>
            </ul>
        </div>
        <table width="100%" class="bdr2 pad">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="right">{{ rp($rb->nominal - $rb->ppn_nominal) }}</td>
                </tr>
                <tr>
                    <td align="right" colspan="7"><strong>PPN @if($rb->ppn > 0) ({{ $rb->ppn }}%) @endif</strong></td>
                    <td align="right">{{ rp($rb->ppn_nominal) }}</td>
                </tr>
                <tr>
                    <td align="right" colspan="7"><strong>Grand Total</strong></td>
                    <td align="right">{{rp($rb->nominal)}}</td>
                </tr>
            </tbody>
        </table>
