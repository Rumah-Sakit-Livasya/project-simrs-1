...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        @include('pages.simrs.warehouse.penerimaan-barang.partials.non-pharmacy-form')

        @include('pages.simrs.warehouse.penerimaan-barang.partials.non-pharmacy-datatable')
    </main>
@endsection
@section('plugin')
