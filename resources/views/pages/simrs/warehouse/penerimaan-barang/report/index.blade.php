@extends('inc.layout')
@section('title', 'List Retur Barang')
@section('content')
    <main id="js-page-content" role="main" class="page-content">

        @include('pages.simrs.warehouse.penerimaan-barang.report.partials.index-form')
    </main>
@endsection
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/warehouse/penerimaan-barang/report.js') }}?v={{ time() }}"></script>
