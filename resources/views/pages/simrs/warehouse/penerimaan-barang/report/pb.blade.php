...
<body>
    ...
    <div id="previews">
        <h2 class="bdr">
            Laporan Penerimaan Barang per Faktur
        ...
        <table width="100%" class="bdr2 pad">
            ...
            <tbody>
                @foreach ($pbs as $pb)
                    <tr>
                        <td colspan="7"><b>{{ $pb->supplier->nama }}, PB: {{ $pb->kode_penerimaan }}, PO:
                                {{ $pb->po ? $pb->po->kode_po : ' - ' }}, Tgl.
                                Terima:
                                {{ tgl($pb->tanggal_terima) }}, Tgl. Faktur:
                                {{ isset($pb->tanggal_faktur) ? tgl($pb->tanggal_faktur) : ' - ' }}, No Faktur:
                                {{ $pb->no_faktur }}</b></td>
                    </tr>
                    @foreach ($pb->items as $item)
                        <tr>
                            <td align="center">{{ $loop->iteration }}</td>
                            <td>{{ $item->nama_barnag }}</td>
                    ...
                    <tr style="text-align: right; font-weight: bold;">
                        <td colspan="6">Diskon Final</td>
                        <td>{{ rp($pb->items->sum('diskon_nominal') + $pb->diskon_faktur) }}</td>
                    </tr>
                    <tr style="text-align: right; font-weight: bold;">
                        <td colspan="6">PPN</td>
