        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <form action="{{ route('warehouse.master-data.setup-min-max-stock') }}" method="get">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl">
                                            <select name="gudang_id" id="gudang_id" class="form-control">
                                                <option value="" selected hidden disabled>Pilih Gudang</option>
                                                @foreach ($gudangs as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ request('gudang_id') == $item->id ? 'selected' : '' }}>
                                                        {{ $item->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                        ...
                        <div class="row justify-content-end mt-3">
                            ...
                            <div class="col-xl-3">
                                <a href="{{ route('warehouse.master-data.setup-min-max-stock.create') }}" class="btn btn-primary waves-effect waves-themed" id="tambah-btn">
                                    Setup Min Max
                                </a>
                            </div>
                        </div>
