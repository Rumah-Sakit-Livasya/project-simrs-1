<div class="modal fade" id="editModal{{ $pabrik->id }}" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('warehouse.master-data.pabrik.update', ['id' => $pabrik->id ]) }}" method="post">
                @csrf
                @method('put')
                ...
                <div class="modal-body">
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" value="{{ $pabrik->nama }}"
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" value="{{ $pabrik->alamat }}"
                                    style="border: 0; border-bottom: 1.9px solid #eaeaea; margin-top: -.5rem; border-radius: 0"
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" value="{{ $pabrik->telp }}"
                                    style="border: 0; border-bottom: 1.9px solid #eaeaea; margin-top: -.5rem; border-radius: 0"
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" value="{{ $pabrik->contact_person }}"
                                    style="border: 0; border-bottom: 1.9px solid #eaeaea; margin-top: -.5rem; border-radius: 0"
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" value="{{ $pabrik->contact_person_phone }}"
                                    style="border: 0; border-bottom: 1.9px solid #eaeaea; margin-top: -.5rem; border-radius: 0"
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="aktif"
                                        id="status_aktif_true" value="1" {{ $pabrik->aktif ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="aktif"
                                        id="status_aktif_false" value="0" {{ !$pabrik->aktif ? 'checked' : '' }}>
