@extends('inc.layout')
@section('title', 'Master Barang Non Farmasi')

@section('content')
    <main id="js-page-content" role="main" class="page-content">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-box'></i> Master <span class='fw-300'>Barang Non Farmasi</span>
                <small>Manajemen data master untuk barang non farmasi.</small>
            </h1>
        </div>
        <div class="row mb-3">
            <div class="col-xl-12">
                ...
                <form id="filter-form" class="form-inline">
                    ...
                    <div class="form-group mr-2 mb-2">
                        <input type="text" class="form-control" id="filter_kelompok" placeholder="Kelompok">
                    </div>
                    <div class="form-group mr-2 mb-2">
                        <input type="text" class="form-control" id="filter_golongan" placeholder="Golongan">
                    </div>
                    <div class="form-group mr-2 mb-2">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>Daftar <span class="fw-300"><i>Barang Non Farmasi</i></span></h2>
                        <div class="panel-toolbar">
                            <button class="btn btn-primary btn-sm"
                                onclick="openPopup('{{ route('warehouse.master-data.barang-non-farmasi.create') }}')">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <table id="dt-barang-non-farmasi" class="table table-bordered table-hover table-striped w-100">
    ...
    <div class="modal fade" id="import-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <form id="import-form" action="{{ route('warehouse.master-data.barang-non-farmasi.import') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><i class="fal fa-upload"></i> Import Barang Non Farmasi dari Excel</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            <a href="{{ route('warehouse.master-data.barang-non-farmasi.export') }}"
...
@section('plugin')
    ...
    <script>
        function openPopup(url) {
            ...
            var timer = setInterval(function() {
                if (popupWindow.closed) {
                    clearInterval(timer);
                    $('#dt-barang-non-farmasi').DataTable().ajax.reload();
                }
            }, 1000);
        }
        ...
        $(document).ready(function() {
            ...
            var table = $('#dt-barang-non-farmasi').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('warehouse.master-data.barang-non-farmasi.data') }}",
                    data: function(d) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return row.kategori && row.kategori.nama ? row.kategori.nama : '-';
                        }
                    },
                    {
                        data: 'kelompok.nama',
                        name: 'kelompok.nama',
                        render: function(data, type, row) {
                            return row.kelompok && row.kelompok.nama ? row.kelompok.nama : '-';
                        }
                    },
                    {
                        data: 'golongan.nama',
                        name: 'golongan.nama',
                        render: function(data, type, row) {
                            return row.golongan && row.golongan.nama ? row.golongan.nama : '-';
                        }
                    },
                    {
                        data: 'satuan.nama',
                        name: 'satuan.nama',
                        render: function(data, type, row) {
                            return row.satuan && row.satuan.nama ? row.satuan.nama : '-';
                        }
                    },
                    {
                        data: 'hna',
                ...
                buttons: [{
                    ...
                    action: function() {
                        openPopup(
                            "{{ route('warehouse.master-data.barang-non-farmasi.create') }}"
                        );
                    }
                }]
            });
            ...
            // Delete button click
            $('#dt-barang-non-farmasi').on('click', '.delete-btn', function() {
