@extends('inc.layout')
@section('title', 'Master Golongan Barang')

@section('content')
    <main id="js-page-content" role="main" class="page-content">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-object-group'></i> Master <span class='fw-300'>Golongan Barang</span>
                <small>
                    Manajemen data master untuk golongan barang.
                </small>
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Daftar <span class="fw-300"><i>Golongan Barang</i></span>
                        </h2>
                        <div class="panel-toolbar">
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add-modal">
                                <i class="fal fa-plus"></i> Tambah Golongan
                            </button>
                        </div>
                    </div>
                    <div class="panel-container show">
                        <div class="panel-content">
                            <!-- datatable start -->
                            <table id="dt-golongan-barang" class="table table-bordered table-hover table-striped w-100">
            ...
            <div class="modal-content">
                <form id="add-form" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Golongan Barang</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label" for="add-kode">Kode Golongan</label>
                            <input type="text" id="add-kode" name="kode" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="add-nama">Nama Golongan</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="edit-form" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Golongan Barang</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true"><i class="fal fa-times"></i></span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label" for="edit-kode">Kode Golongan</label>
                            <input type="text" id="edit-kode" name="kode" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="edit-nama">Nama Golongan</label>
...
@section('plugin')
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#dt-golongan-barang').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('warehouse.master-data.golongan-barang.data') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('#add-form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('warehouse.master-data.golongan-barang.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
            ...
            // Edit button click
            $('#dt-golongan-barang').on('click', '.edit-btn', function() {
                ...
                $.get(url, function(response) {
                    if (response.success) {
                        ...
                        var updateUrl = "{{ url('warehouse/master-data/golongan-barang') }}/" + data
                            .id;
            ...
            $('#edit-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        'Gagal memperbarui. Pastikan kode & nama unik.');
                    }
                });
            });

            // Delete button click
            $('#dt-golongan-barang').on('click', '.delete-btn', function() {
                var url = $(this).data('url');
