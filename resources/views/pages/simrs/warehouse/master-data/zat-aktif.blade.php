@extends('inc.layout')
@section('title', 'Master Zat Aktif')

@section('content')
    <main id="js-page-content" role="main" class="page-content">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-atom-alt'></i> Master <span class='fw-300'>Zat Aktif</span>
                <small>
                    Manajemen data master untuk zat aktif.
                </small>
            </h1>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Daftar <span class="fw-300"><i>Zat Aktif</i></span>
                        </h2>
                        <div class="panel-toolbar">
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add-modal">
                                <i class="fal fa-plus"></i> Tambah Zat Aktif
                            </button>
                        </div>
                    </div>
                    <div class="panel-container show">
                        <div class="panel-content">
                            <!-- datatable start -->
                            <table id="dt-zat-aktif" class="table table-bordered table-hover table-striped w-100">
                ...
                <form id="add-form" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label" for="add-kode">Kode Zat</label>
                            <input type="text" id="add-kode" name="kode" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="add-nama">Nama Zat</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="edit-form" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label" for="edit-kode">Kode Zat</label>
                            <input type="text" id="edit-kode" name="kode" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="edit-nama">Nama Zat</label>
...
@section('plugin')
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#dt-zat-aktif').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('warehouse.master-data.zat-aktif.data') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('#add-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('warehouse.master-data.zat-aktif.store') }}",
                    type: "POST",
                    data: formData,
            ...
            // Edit button click
            $('#dt-zat-aktif').on('click', '.edit-btn', function() {
                ...
                $.get(url, function(response) {
                    if (response.success) {
                        ...
                        var updateUrl = "{{ url('warehouse/master-data/zat-aktif') }}/" + data.id;
            ...
            $('#edit-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        showErrorAlert('Gagal memperbarui data.');
                    }
                });
            });

            // Delete button click
            $('#dt-zat-aktif').on('click', '.delete-btn', function() {
                var url = $(this).data('url');
