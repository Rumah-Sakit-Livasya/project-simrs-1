...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        @include('pages.simrs.warehouse.distribusi-barang.report.partials.index-form')
    </main>
@endsection
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/warehouse/distribusi-barang/report.js') }}?v={{ time() }}"></script>
