...
<body>
    ...
    <div id="previews">
        ...
        <h2 class="bdr">
            <span class="rgt"><span class="til">Kode Transaksi</span><span>{{ $db->kode_db }}</span></span>
            DISTRIBUSI BARANG
            <span>Tanggal : {{ tgl($db->tanggal_db) }}</span>
        </h2>

        <table width="100%" class="bdr2 pad">
            <tbody>
                <tr>
                    <td width="15%" class="label"><strong>Gudang Asal</strong></td>
                    <td>: {{ $db->asal->nama }}</td>
                </tr>
                <tr>
                    <td width="15%" class="label"><strong>Gudang Tujuan</strong></td>
        ...
        <table width="100%" class="bdr2 pad">
            ...
            <tfoot>
                <tr>
                    <td class="label" colspan="6">Notes : {{ $db->keterangan }}</td>
                </tr>
            </tfoot>
        </table>
