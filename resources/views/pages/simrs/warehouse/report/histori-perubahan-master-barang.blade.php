...
@section('content')
    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        @include('pages.simrs.warehouse.report.partials.histori-perubahan-master-barang-form')

        @include('pages.simrs.warehouse.report.partials.histori-perubahan-master-barang-datatable')
    </main>
@endsection
@section('plugin')
