                    ...
                    <div class="panel-container show">
                        ...
                        <div class="panel-content">
                            <form id="form-pr" name="form-pr"
                                action="{{ route('warehouse.purchase-request.non-pharmacy.store') }}" method="post">
                                @csrf
                                @method('post')
...
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/warehouse/purchase-request/popup-non-pharmacy.js') }}"></script>
@endsection
