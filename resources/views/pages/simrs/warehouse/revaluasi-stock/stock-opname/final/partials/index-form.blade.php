<div class="row justify-content-center">
    <div class="col-xl-8">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    Stock Opname: <span class="fw-300"><i>Final</i></span>
                    &nbsp;
            ...
            <div class="panel-container show">
                ...
                <div class="panel-content">
                    ...
                    <div class="row justify-content-end mt-3">
                        ...
                        <div class="col-2">
                            <button class="btn btn-primary waves-effect waves-themed" id="refresh-so-btn">
                                <span class="mdi mdi-refresh pointer mdi-12px"></span>
                                Refresh SO
                            </button>
                        </div>
                        <div class="col-2">
                            <button class="btn btn-primary waves-effect waves-themed" id="save-final-btn">
