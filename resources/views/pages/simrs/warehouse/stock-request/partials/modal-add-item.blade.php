    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-subtitle fs-3">Double click untuk memilih</h3>
            </div>
            <div class="modal-body">
                <input type="text" id="searchItemInput" placeholder="Cari barang..." class="form-control">
                <br>
                <select class="form-control" id="itemSourceSelect">
                    <option value="stock" selected>Stock Gudang</option>
                    <option value="barang">Master Data</option>
                </select>
                <br>
