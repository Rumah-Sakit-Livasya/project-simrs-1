                    ...
                    <div class="panel-container show">
                        ...
                        <div class="panel-content">
                            <form id="form-pr" name="form-pr"
                                action="{{ route('warehouse.stock-request.non-pharmacy.update', $sr->id) }}" method="post">
                                @csrf
                                @method('put')
...
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/warehouse/stock-request/popup-non-pharmacy.js') }}?v={{ time() }}"></script>
@endsection
