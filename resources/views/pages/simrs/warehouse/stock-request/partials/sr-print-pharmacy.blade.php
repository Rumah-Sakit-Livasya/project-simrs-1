...
<body>
    ...
    <div id="previews">
        <h2 class="bdr">
            <span class="rgt"><span class="til">NO SR #</span><span>{{ $sr->kode_sr }}</span></span>
            Stock Request
            <span>Tanggal : {{ tgl($sr->tanggal_sr) }}</span>
        </h2>

        <div id="hhr" class="ful">
            <ul>
                <li><span>Asal SR</span>: {{ $sr->asal->nama }}</li>
                <li><span>Tujuan SR</span>: {{ $sr->tujuan->nama }}</li>
                <li><span>Keterangan</span>: {{ $sr->keterangan }}</li>
            </ul>
        </div>
