@extends('inc.layout')
@section('title', 'Laporan Discount')
        ...
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>Laporan <span class="fw-300"><i>Discount</i></span></h2>
                    </div>
                    <div class="panel-container show">
                        <div class="panel-content">
                            <form id="laporan-discount-form">
                                <div class="row mb-3">
                                    <!-- Periode Awal -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-cari').on('click', function(e) {
                e.preventDefault();
                const form = $('#laporan-discount-form');
                const formData = form.serialize();
                const reportUrl = "{{ route('laporan.discount.report') }}?" + formData;
            ...
            $('#laporan-discount-form').on('keypress', function(e) {
                if (e.which === 13) {
                    e.preventDefault();
                    $('#btn-cari').click();
                }
