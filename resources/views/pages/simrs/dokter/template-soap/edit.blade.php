@extends('inc.layout')
@section('title', 'Edit Template SOAP')
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            <i class="fal fa-edit mr-2"></i> Formulir Edit Template SOAP
                        </h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <form method="post" action="{{ route('dokter.template-soap.update', $soapTemplate->id) }}"
                                autocomplete="off">
                                @csrf
                                @method('PUT')
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="template_name" id="template_name"
                                            value="{{ old('template_name', $soapTemplate->template_name) }}"
                                ...
                                <div class="row">
                                        ...
                                        <div class="card border mb-g">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea class="form-control" id="subjective" name="subjective" rows="8">{{ old('subjective', $soapTemplate->subjective) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="card border mb-g">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea class="form-control" id="objective" name="objective" rows="8">{{ old('objective', $soapTemplate->objective) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="card border mb-g">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea class="form-control" id="assesment" name="assesment" rows="8">{{ old('assesment', $soapTemplate->assesment) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="card border mb-g">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea class="form-control" id="planning" name="planning" rows="8">{{ old('planning', $soapTemplate->planning) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
