        ...
        <div class="print">
            <div class="print_function" id="divButtons">
                ...
                <input type="button" value="XLS"
                    onclick="window.location.replace('http://192.168.1.253/testing/lab_report/print_pemeriksaan_per_parameter/01-04-2025/17-04-2025/otc/yes?mtlid=1');">
                <input type="button" value="Close" onclick="JavaScript:window.close();">
            </div>
            <h1>
                REKAP PARAMETER PER PEMERIKSAAN
                        ...
                        <td>
                            ...
                            <table width="100%" class="bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($reports as $nama_grup => $parameters)
                                        @foreach ($parameters as $nama_parameter => $jumlah)
                                            <tr>
                                                <td align="center">{{ $nama_grup }}</td>
