@extends('inc.layout')
@section('title', 'List Jam Makan')
@section('content')
    <main id="js-page-content" role="main" class="page-content">

        @include('pages.simrs.gizi.partials.jam-makan-form')

        @include('pages.simrs.gizi.partials.jam-makan-datatable')

        @include('pages.simrs.gizi.partials.add-jam-makan-modal')
    </main>
@endsection
@section('plugin')
...
<script src="{{ asset('js/simrs/jam-makan-gizi.js') }}?v={{ time() }}"></script>
