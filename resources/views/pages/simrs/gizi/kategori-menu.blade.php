@extends('inc.layout')
@section('title', 'List Kategori Menu')
@section('content')
    <main id="js-page-content" role="main" class="page-content">

        @include('pages.simrs.gizi.partials.kategori-menu-form')

        @include('pages.simrs.gizi.partials.kategori-menu-datatable')
...
@section('plugin')
    ...
    <script src="{{ asset('js/simrs/kategori-gizi.js') }}?v={{ time() }}"></script>
@endsection
