<div class="modal fade" id="modal-back" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form autocomplete="off" novalidate action="javascript:void(0)" method="post" enctype="multipart/form-data"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control w-100 @error('ruang_pinjam') is-invalid @enderror" id="ruang_pinjam"
                            name="ruang_pinjam">
