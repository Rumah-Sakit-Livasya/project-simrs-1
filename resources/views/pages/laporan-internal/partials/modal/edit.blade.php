...
<div class="modal fade" id="ubah-data" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-header bg-primary text-white">
            <h5 class="modal-title">Ubah Laporan Baru</h5>
            ...
            <form id="edit-form-laporan" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="edit-jenis" class="font-weight-bold">Jenis Laporan</label>
                                <select class="form-control select2" id="edit-jenis" name="jenis" required>
                        ...
                        <div class="col-md-4" id="edit-organization-field" style="display: none">
                            <div class="form-group">
                                <label for="edit-unit-terkait" class="font-weight-bold">Unit</label>
                                <select class="form-control select2" id="edit-unit-terkait" name="unit_terkait">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="edit-kegiatan" class="font-weight-bold">Uraian Lengkap</label>
                                <textarea class="form-control" id="edit-kegiatan" name="kegiatan" rows="4" required
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="edit-status" class="font-weight-bold">Status</label>
                            ...
                            <div class="form-group" id="edit-keterangan-field" style="display: none;">
                                <label for="keterangan" class="font-weight-bold">Keterangan</label>
                                <textarea class="form-control" id="edit-keterangan-field" name="keterangan" rows="4"
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <div class="form-group">
                                <label for="edit-dokumentasi" class="form-label">Dokumentasi (Opsional)</label>
                                <!-- Tempat untuk menampilkan preview gambar atau link PDF -->
                                <div id="dokumentasi-preview" class="my-3" style="display: none;">
                                    <!-- Preview gambar atau link PDF akan muncul di sini -->
                                </div>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="edit-dokumentasi"
                                        name="dokumentasi" accept=".jpg,.jpeg,.png,.pdf">
                                    <label class="custom-file-label" for="edit-dokumentasi">Choose file</label>
                                </div>
