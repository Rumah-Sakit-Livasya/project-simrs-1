...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        ...
        @include('pages.master-data.attendance-code.partials.create-data')
        @include('pages.master-data.attendance-code.partials.update-data')
    </main>
@endsection
@section('plugin')
    ...
    <script>
        ...
        $(document).ready(function() {
            let attendance_code_id = null;
            $('.btn-edit').click(function(e) {
                e.preventDefault();
                let button = $(this);
                console.log('clicked');
                let id = button.attr('data-id');
                attendance_code_id = id;
                button.find('.ikon-edit').hide();
                button.find('.spinner-text').removeClass('d-none');

                $.ajax({
                    type: "GET", // Method pengiriman data bisa dengan GET atau POST
                    url: `/api/dashboard/attendance-codes/get/${id}`, // Isi dengan url/path file php yang dituju
                    dataType: "json",
                    success: function(data) {
                        ...
                        $('#ubah-data #description').val(data.description)
                    },
                    error: function(xhr) {
            ...
            $('#update-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: '/api/dashboard/attendance-codes/update/' + attendance_code_id,
                    data: formData,
                    beforeSend: function() {
            ...
            $('#store-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: '/api/dashboard/attendance-codes/store',
                    data: formData,
                    beforeSend: function() {
            ...
            $('.btn-hapus').click(function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: '/api/dashboard/attendance-codes/delete/' + id,
                    beforeSend: function() {
