...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
        <div class="row mb-5">
            <div class="col-xl-12">
                <a type="button" href="{{ route('kpi.tbh.aspek-penilaian') }}"
                            ...
                            <table id="Penilaian" class="table table-bordered table-hover table-striped w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="white-space: nowrap">Aspek Penilaian</th>
                                        <th style="white-space: nowrap">Bobot</th>
                                        <th style="white-space: nowrap">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($aspek_penilaians as $row)
                                        <tr>
                                            {{-- <td style="white-space: nowrap">{{ $user->template_user->foto }}</td> --}}
                                            <td style="white-space: nowrap">{{ $loop->iteration }}</td>
                                            <td style="white-space: nowrap">{{ $row->group_penilaian->nama_group }}</td>
                                            <td style="white-space: nowrap">{{ $row->nama }}</td>
                                            <td style="white-space: nowrap">{{ $row->bobot }}</td>
