@extends('inc.layout')
@section('title', 'Kategori Checklist Harian')
@section('content')
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div id="form-container" style="display: none;" class="panel form-container">
                    <div class="panel-hdr">
                        <h2>
                            Form Tambah Kategori Checklist
                        </h2>
                    </div>
                            ...
                            <form autocomplete="off" novalidate action="javascript:void(0)" id="store-form" method="post">
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <select class="form-control select2 @error('status') is-invalid @enderror"
                                        ...
                                        <option value="Ya" {{ old('status') == '' ? 'selected' : '' }}>Ya</option>
                ...
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Table <span class="fw-300"><i>Kategori Checklist</i></span>
                        </h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                ...
                                <tbody>
                                    @foreach ($checklistHarianCategory as $row)
                                        <tr>
                                            <td style="white-space: nowrap">{{ $loop->iteration }}</td>
                                            <td style="white-space: nowrap">{{ $row->name }}</td>
                                            <td style="white-space: nowrap">{{ $row->is_active ? 'Aktif' : 'Nonaktif' }}
                                            </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-edit').click(function() {
                ...
                $.ajax({
                    url: '/api/dashboard/checklist-harian/category/' + categoryId,
                    type: 'GET',
                    success: function(response) {
                        // Isi form dengan data yang diterima
                        $('#modal-edit #name').val(response.name);
                        $('#modal-edit #is_active').prop('checked', response.is_active === 1);
                    },
            ...
            $('#update-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '/api/dashboard/checklist-harian/category/' + categoryId + '/update',
                    type: 'PATCH',
                    data: formData,
                    beforeSend: function() {
            ...
            $('#store-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '/api/dashboard/checklist-harian/category/store',
                    type: 'POST',
                    data: formData,
                    beforeSend: function() {
        ...
        function toggleForm() {
            ...
            if (formContainer.style.display === 'none' || formContainer.style.display === '') {
                ...
                toggleButton.innerText = 'Tambah Kategori Checklist';
            } else {
                formContainer.style.maxHeight = '0';
                setTimeout(function() {
                    formContainer.style.display = 'none';
