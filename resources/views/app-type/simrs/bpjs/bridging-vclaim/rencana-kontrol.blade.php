@extends('inc.layout')
@section('title', 'Rencana Kontrol Pasien')
...
@section('content')
    <main id="js-page-content" role="main" class="page-content">
                ...
                <div class="panel-content">
                    <form id="form-search">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Status Rencana Kontrol</label>
                                    <select name="show_rencana_kontrol" id="show_rencana_kontrol"
                                        class="form-control select2">
                                        <option value="">Semua</option>
                                        <option value="sudah">Sudah di Buat Rencana Kontrol</option>
                                        <option value="belum">Belum di Buat Rencana Kontrol</option>
                                    </select>
                                </div>
                                <div class="form-group">
        ...
        <div class="panel">
            <div class="panel-hdr">
                <h2><i class="fas fa-list-alt mr-2"></i> Daftar Rencana Kontrol Pasien BPJS Kesehatan</h2>
            </div>
            <div class="panel-container show">
                <div class="panel-content">
                    <table id="rencana-kontrol-table" class="table table-bordered table-hover table-striped w-100">
...
@section('plugin')
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#rencana-kontrol-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            let url =
                            `{{ url('vclaim/form_rencana_kontrol/2') }}/${row.id}`; // 2 = Jenis Kontrol (contoh)
                            let title = (row.no_surat_kontrol !== '-') ? 'Edit Rencana Kontrol' :
