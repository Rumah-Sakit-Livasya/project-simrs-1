                            ...
                            <div class="panel-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control datepicker" name="tanggal_jurnal"
                                                id="tanggal_jurnal" placeholder="Pilih tanggal jurnal"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control money" id="total_penerimaan"
                                            value="Rp 0" readonly>
                                        <input type="hidden" name="total_penerimaan_hidden" id="total_penerimaan_hidden"
                                            value="0">
                                    </div>
