@extends('inc.layout')
@section('title', 'Buat Petty Cash Baru')
@section('content')
    <style>
        .status-icon {
            cursor: pointer;
    ...
    <main id="js-page-content" role="main" class="page-content">
        <form action="{{ route('keuangan.petty-cash.store') }}" method="POST" id="create-petty-cash-form">
            @csrf
            <div class="row justify-content-center">
                                            ...
                                            <select class="form-control select2" id="kas_id" name="kas_id" required>
                                                ...
                                                @foreach ($kass as $kas)
                                                    <option value="{{ $kas->id }}"
                                                        ...
                                                        {{ $kas->nama_bank }}</option>
                                                @endforeach
                                            </select>
                                        </div>

                                        {{-- TAMBAHAN: Form Control untuk Saldo --}}
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="keterangan" name="keterangan" rows="2"
                                                placeholder="Masukkan keterangan umum transaksi...">{{ old('keterangan') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-12 mt-4">
                    {{-- ... Panel Tabel Detail sama seperti sebelumnya, tidak ada perubahan ... --}}
                    <div class="panel">
                        <div class="panel-hdr">
...
@section('plugin')
    ...
    <script>
        $(document).ready(function() {
            ...
            // ==========================================================
            // TAMBAHAN: Logika AJAX untuk mengambil Saldo Kas/Bank
            // ==========================================================
            $('#kas_id').on('change', function() {
                ...
                if (kasId) {
                    ...
                    // URL ke route yang sudah kita buat
            ...
            // Event handler untuk menghapus baris (tetap sama)
