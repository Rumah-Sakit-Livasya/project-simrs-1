    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="row g-5">
            <div class="col-lg-3 mt-5">
                <div id="cp-2" class="card border" style="border-radius: 10px">
                    <div class="card-body p-0 bg-info-300" style="border-radius: 10px">
                        <div class="custom-scroll" style="height: 160px">
                            <div class="inner" style="margin: 1rem">
                                <h2 class="mt-5" style="font-weight: bolder">Rp.
                                    {{ number_format($tampilPemasukanHariIni) }} ,-</h2>
                                <p class="mt-5">Pemasukan Hari Ini</p>
                            </div>
                        </div>
                        <div class="card-footer bg-info-800 py-2 text-center">
            ...
            <div class="col-lg-3 mt-5">
                <div id="cp-2" class="card border" style="border-radius: 10px">
                    <div class="card-body p-0 bg-warning-300" style="border-radius: 10px">
                        <div class="custom-scroll" style="height: 160px">
                            <div class="inner" style="margin: 1rem">
                                <h2 class="mt-5" style="font-weight: bolder">Rp.
                                    {{ number_format($tampilPemasukanBulanIni) }} ,-</h2>
                                <p class="mt-5">Pemasukan Bulan Ini</p>
                            </div>
                        </div>
                        <div class="card-footer bg-warning-800 py-2 text-center">
                            <i class="fas fa-dollar-sign"></i>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 mt-5">
                <div id="cp-2" class="card border" style="border-radius: 10px">
                    <div class="card-body p-0 bg-danger-300" style="border-radius: 10px">
                        <div class="custom-scroll" style="height: 160px">
                            <div class="inner" style="margin: 1rem">
                                <h2 class="mt-5" style="font-weight: bolder">Rp.
                                    {{ number_format($tampilPemasukanTahunIni) }} ,-</h2>
                                <p class="mt-5">Pemasukan Tahun Ini</p>
                            </div>
                        </div>
                        <div class="card-footer bg-danger-800 py-2 text-center">
                            <i class="fas fa-dollar-sign"></i>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 mt-5">
                <div id="cp-2" class="card border" style="border-radius: 10px">
                    <div class="card-body p-0 bg-success-300" style="border-radius: 10px">
                        <div class="custom-scroll" style="height: 160px">
                            <div class="inner" style="margin: 1rem">
                                <h2 class="mt-5" style="font-weight: bolder">Rp.
                                    {{ number_format($tampilSeluruhPemasukan) }} ,-</h2>
                                <p class="mt-5">Seluruh Pemasukan</p>
                            </div>
                        </div>
                        <div class="card-footer bg-success-800 py-2 text-center">
                            <i class="fas fa-dollar-sign"></i>
                        </div>
                    </div>
                </div>
                ...
                <div id="cp-2" class="card border" style="border-radius: 10px">
                    <div class="card-body p-0 bg-info-300" style="border-radius: 10px">
                        <div class="custom-scroll" style="height: 160px">
                            <div class="inner" style="margin: 1rem">
                                <h2 class="mt-5" style="font-weight: bolder">Rp.
                                    {{ number_format($tampilPengeluaranHariIni) }} ,-</h2>
                                <p class="mt-5">Pengeluaran Hari Ini</p>
                            </div>
                        </div>
                        <div class="card-footer bg-info-800 py-2 text-center">
                            <i class="fas fa-dollar-sign"></i>
                ...
                <div id="cp-2" class="card border" style="border-radius: 10px">
                    <div class="card-body p-0 bg-warning-300" style="border-radius: 10px">
                        <div class="custom-scroll" style="height: 160px">
                            <div class="inner" style="margin: 1rem">
                                <h2 class="mt-5" style="font-weight: bolder">Rp.
                                    {{ number_format($tampilPengeluaranBulanIni) }} ,-</h2>
                                <p class="mt-5">Pengeluaran Bulan Ini</p>
                            </div>
                        </div>
                        <div class="card-footer bg-warning-800 py-2 text-center">
                            <i class="fas fa-dollar-sign"></i>
                ...
                <div id="cp-2" class="card border" style="border-radius: 10px">
                    <div class="card-body p-0 bg-danger-300" style="border-radius: 10px">
                        <div class="custom-scroll" style="height: 160px">
                            <div class="inner" style="margin: 1rem">
                                <h2 class="mt-5" style="font-weight: bolder">Rp.
                                    {{ number_format($tampilPengeluaranTahunIni) }} ,-</h2>
                                <p class="mt-5">Pengeluaran Tahun Ini</p>
                            </div>
                        </div>
                        <div class="card-footer bg-danger-800 py-2 text-center">
                            <i class="fas fa-dollar-sign"></i>
                ...
                <div id="cp-2" class="card border" style="border-radius: 10px">
                    <div class="card-body p-0 bg-success-300" style="border-radius: 10px">
                        <div class="custom-scroll" style="height: 160px">
                            <div class="inner" style="margin: 1rem">
                                <h2 class="mt-5" style="font-weight: bolder">Rp.
                                    {{ number_format($tampilSeluruhPengeluaran) }} ,-</h2>
                                <p class="mt-5">Seluruh Pengeluaran</p>
                            </div>
                        </div>
                        <div class="card-footer bg-success-800 py-2 text-center">
                            <i class="fas fa-dollar-sign"></i>
        ...
        $(document).ready(function() {
            ...
            $('#vector-map').vectorMap({
                ...
                onRegionClick: function(element, code, region) {
                    ...
                    $('.js-jqvmap-flag').attr('src', 'img/flags/4x3/' + code.toLowerCase() + '.svg');
