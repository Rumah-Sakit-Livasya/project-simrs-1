...
<body>
    <div class="glass-container tilt" data-tilt data-tilt-max="25" data-tilt-speed="400"
        ...
        <img src="https://cdn-icons-png.flaticon.com/512/564/564619.png" class="maintenance-image"
            alt="Session Expired Illustration">

        <h1 class="title">419 - Session Expired</h1>
        <p class="description">
            Sesi Anda telah berakhir atau kadaluarsa. Silakan muat ulang halaman dan coba lagi.
        </p>
        <p>
