...
<body>
    <div class="glass-container tilt" data-tilt data-tilt-max="25" data-tilt-speed="400">
        <img src="https://cdn-icons-png.flaticon.com/512/564/564619.png" class="error-image"
            alt="500 Error Illustration">
        <div class="error-code">500</div>
        <h1 class="title">Kesalahan Server Internal</h1>
        <p class="description">
            Maaf, terjadi kesalahan pada server kami.<br>
            Silakan coba beberapa saat lagi atau hubungi tim IT jika masalah berlanjut.
        </p>
        <a href="{{ url('/') }}" class="interactive-element">Kembali ke Beranda</a>
