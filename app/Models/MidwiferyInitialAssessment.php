...
class MidwiferyInitialAssessment extends Model
{
    use HasFactory, SoftDeletes;
    protected $table = 'midwifery_initial_assessments';
    ...
    protected $casts = [
        ...
        'obat_dibawa' => 'array',
        'riwayat_kehamilan_saat_ini' => 'array',
        'riwayat_kehamilan_lalu' => 'array',
        'riwayat_kesehatan_pasien' => 'array',
