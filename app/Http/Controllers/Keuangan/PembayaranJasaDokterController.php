...
class PembayaranJasaDokterController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('app-type.keuangan.pembayaran-jasa-dokter.index', compact('data', 'dokters', 'request'));
    }
    ...
    public function create()
    {
        ...
        return view('app-type.keuangan.pembayaran-jasa-dokter.create', compact('dokters', 'banks'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('app-type.keuangan.pembayaran-jasa-dokter.index')->with('success', 'Pembayaran berhasil disimpan.');
    }
}
