...
class FarmasiReportDispensing extends Controller
{
    public function index()
    {
        return view("pages.simrs.farmasi.laporan.dispensing.index", [
    ...
    public function show($startDate, $endDate, $tipe, $doctor_id, $departement_id, $kelas_rawat_id, $nama_obat)
    {
        ...
        // only where penjamin is NOT LIKE standar
        ...
        return view(
            "pages.simrs.farmasi.laporan.dispensing.show",
