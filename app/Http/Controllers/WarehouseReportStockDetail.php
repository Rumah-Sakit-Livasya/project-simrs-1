...
class WarehouseReportStockDetail extends Controller
{
    public function index()
    {
        return view("pages.simrs.warehouse.report.stock-detail", [
    ...
    public function get_items(Request $request)
    {
        $data = $request->validate([
            ...
            "kategori" => "nullable|exists:warehouse_kategori_barang,id",
            "golongan" => "nullable|exists:warehouse_golongan_barang,id",
            "gudang" => "nullable|exists:warehouse_master_gudang,id",
    ...
    public function get_print_template(){
        return view("pages.simrs.warehouse.report.partials.stock-detail-print-template");
    }
}
