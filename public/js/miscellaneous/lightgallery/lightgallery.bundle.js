        ...
        return this.each(function () {
            if (!$.data(this, "lightGallery")) {
                ...
                try {
                    ...
                    console.log("lightGallery has not initiated properly");
                }
            }
        });
    };
                    ...
                    $.getJSON(
                        ...
                        function (data) {
                            $this
                                ...
                                .attr(
                                    "src",
                                    data[0][_this.core.s.vimeoThumbSize]
                                );
                        }
                    );
                }
        ...
        Thumbnail.prototype.animateThumb = function (index) {
            ...
            if (this.core.s.animateThumb) {
                ...
                switch (this.core.s.currentPagerPosition) {
                    ...
                    case "right":
                        position =
                            this.thumbOuterWidth - this.core.s.thumbWidth;
                }
                this.left =
    ...
    (function () {
        ...
        Zoom.prototype.init = function () {
            ...
            var zoom = function (scaleVal) {
                ...
                var offsetX =
                    ($(window).width() - $image.prop("offsetWidth")) / 2;
                var offsetY =
