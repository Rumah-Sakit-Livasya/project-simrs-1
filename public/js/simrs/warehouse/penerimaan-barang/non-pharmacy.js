...
class PBNPharmacyHandler {
    ...
    #handleEditButtonClick(event) {
        ...
        const url = "/simrs/warehouse/penerimaan-barang/non-pharmacy/edit/" + id;
    ...
    #handlePrintButtonClick(event) {
        ...
        const url = "/simrs/warehouse/penerimaan-barang/non-pharmacy/print/" + id;
        const width = screen.width;
        const height = screen.height;
        const left = width - (width / 2);
        const top = height - (height / 2);
    ...
    #handleTambahButtonClick(event) {
        event.preventDefault();
        const url = "/simrs/warehouse/penerimaan-barang/non-pharmacy/create";
        const width = screen.width;
        const height = screen.height;
        const left = width - (width / 2);
        const top = height - (height / 2);
    ...
    #deleteItem(id) {
        ...
        fetch('/api/simrs/warehouse/penerimaan-barang/non-pharmacy/destroy/' + id, {
            method: 'DELETE',
            body: formData,
            headers: {
...
const PBNPharmacyClass = new PBNPharmacyHandler();