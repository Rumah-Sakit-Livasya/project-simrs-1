...
class SRNPharmacyHandler {
    ...
    #handleEditButtonClick(event) {
        ...
        const url = "/simrs/warehouse/stock-request/non-pharmacy/edit/" + id;
    ...
    #handleTambahButtonClick(event) {
        event.preventDefault();
        const url = "/simrs/warehouse/stock-request/non-pharmacy/create";
        const width = screen.width;
        const height = screen.height;
        const left = width - (width / 2);
        const top = height - (height / 2);
    ...
    #handlePrintButtonClick(event) {
        ...
        const url = "/simrs/warehouse/stock-request/non-pharmacy/print/" + id;
        const width = screen.width;
        const height = screen.height;
        const left = width - (width / 2);
        const top = height - (height / 2);
    ...
    #deleteItem(id) {
        ...
        fetch('/api/simrs/warehouse/stock-request/non-pharmacy/destroy/' + id, {
            method: 'DELETE',
            body: formData,
            headers: {
...
const SRNPharmacyClass = new SRNPharmacyHandler();
