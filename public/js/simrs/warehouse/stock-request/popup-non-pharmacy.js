...
class PopupSRNPharmacyHandler {
    ...
    */
    ...
    #API_URL = "/api/simrs/warehouse/stock-request/non-pharmacy";
        ...
        return /*html*/`
            <tr id="item${key}">
                ...
                <td><a class="mdi mdi-close pointer mdi-24px text-danger delete-btn"
                        title="Hapus" onclick="PopupSRNPharmacyClass.deleteItem(${key}, '${key_cache}')"></a></td>
            </tr>
        `;
    }
...
const PopupSRNPharmacyClass = new PopupSRNPharmacyHandler();