...
class BarangNonFarmasiHandler {
    ...
    #handleEditButtonClick(event) {
        ...
        const url = "/simrs/warehouse/master-data/barang-non-farmasi/edit/" + id;
        ...
        window.open(
            url,
            "popupWindow_editBarangNonFarmasi" + id,
    ...
    #handleAddButtonClick(event) {
        event.preventDefault();
        const url = "/simrs/warehouse/master-data/barang-non-farmasi/create";
        const width = screen.width;
        const height = screen.height;
        const left = width - (width / 2);
        const top = height - (height / 2);
        window.open(
            url,
            "popupWindow_addBarangNonFarmasi",
            "width=" + width + ",height=" + height +
            ",scrollbars=yes,resizable=yes,left=" + left + ",top=" + top
        );
    }
    ...
    #deleteItem(id) {
        ...
        fetch('/api/simrs/warehouse/master-data/barang-non-farmasi/destroy/' + id, {
            method: 'DELETE',
            body: formData,
            headers: {
...
const BarangNonFarmasiClass = new BarangNonFarmasiHandler();