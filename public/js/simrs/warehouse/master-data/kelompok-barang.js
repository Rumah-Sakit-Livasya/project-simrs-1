...
class KelompokBarangHandler {
    ...
    #deleteItem(id) {
        ...
        fetch('/api/simrs/warehouse/master-data/kelompok-barang/destroy/' + id, {
            method: 'DELETE',
            body: formData,
            headers: {
...
const KelompokBarangClass = new KelompokBarangHandler();