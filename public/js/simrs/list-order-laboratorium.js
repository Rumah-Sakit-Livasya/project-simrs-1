...
class LaboratoriumOrderHandler {
    constructor() {
    ...
    #handlePayClick(event) {
        ...
        Swal.fire({
            ...
            html: "Konfirmasi order Laboratorium menjadi tagihan pasien?",
            icon: "question",
            focusConfirm: true,
    ...
    #handleEditClick(event) {
        ...
        const url = `/simrs/laboratorium/edit-order/${id}`;
    ...
    #handleNotaClick(event) {
        ...
        const url = `/simrs/laboratorium/nota-order/${id}`;
    ...
    #handleResultClick(event) {
        ...
        const url = `/simrs/laboratorium/hasil-order/${id}`;
    ...
    #handleLabelClick(event) {
        ...
        const url = `/simrs/laboratorium/label-order/${id}`;
...
const LaboratoriumOrderHandlerClass = new LaboratoriumOrderHandler();
