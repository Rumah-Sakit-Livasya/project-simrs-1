...
class APRNPharmacyHandler {
    ...
    #handleEditButtonClick(event) {
        ...
        const url = "/simrs/procurement/approval-pr/non-pharmacy/edit/" + id;
        ...
        window.open(
            url,
            "popupWindow_editAPRNFarmasi" + id,
            "width=" +
                width +
                ",height=" +
                height +
    ...
    #handlePrintButtonClick(event) {
        ...
        const url = "/simrs/procurement/approval-pr/non-pharmacy/print/" + id;
        const width = screen.width;
        const height = screen.height;
        const left = width - width / 2;
        const top = height - height / 2;
    ...
    #handleTambahButtonClick(event) {
        event.preventDefault();
        const url = "/simrs/procurement/approval-pr/non-pharmacy/create";
        const width = screen.width;
        const height = screen.height;
        const left = width - width / 2;
        const top = height - height / 2;
    ...
    #deleteItem(id) {
        ...
        fetch("/api/simrs/procurement/approval-pr/non-pharmacy/destroy/" + id, {
            method: "DELETE",
            body: formData,
            headers: {
                "X-CSRF-TOKEN":
...
const APRNPharmacyClass = new APRNPharmacyHandler();
