...
class PopupPRNPharmacyHandler {
    ...
    #API_URL = "/api/simrs/procurement/purchase-request/non-pharmacy";
        ...
        return /*html*/ `
            ...
            satuan.id
                ...
                <td><input type="number" name="qty[${key}]" min="0" step="1" class="form-control" value="${qty}"
                    onkeyup="PopupPRNPharmacyClass.refreshTotal()" onchange="PopupPRNPharmacyClass.refreshTotal()"></td>
                <td>${this.#rp(item.hna)}
                ...
                <td><a class="mdi mdi-close pointer mdi-24px text-danger delete-btn"
                        title="Hapus" onclick="PopupPRNPharmacyClass.deleteItem(${key})"></a></td>
            </tr>
        `;
    }
...
const PopupPRNPharmacyClass = new PopupPRNPharmacyHandler();
