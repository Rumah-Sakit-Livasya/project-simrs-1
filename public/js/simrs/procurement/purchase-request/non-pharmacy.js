...
class PRNPharmacyHandler {
    ...
    #handleEditButtonClick(event) {
        ...
        const url =
            "/simrs/procurement/purchase-request/non-pharmacy/edit/" + id;
    ...
    #handlePrintButtonClick(event) {
        ...
        const url =
            "/simrs/procurement/purchase-request/non-pharmacy/print/" + id;
        const width = screen.width;
        const height = screen.height;
        const left = width - width / 2;
        const top = height - height / 2;
    ...
    #deleteItem(id) {
        ...
        fetch(
            "/api/simrs/procurement/purchase-request/non-pharmacy/destroy/" +
                id,
            {
                method: "DELETE",
                body: formData,
