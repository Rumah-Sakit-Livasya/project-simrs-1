...
class APONPharmacyHandler {
    ...
    #handleEditButtonClick(event) {
        ...
        const url = "/simrs/procurement/approval-po/non-pharmacy/edit/" + id;
        ...
        window.open(
            url,
            "popupWindow_editAPONFarmasi" + id,
            "width=" +
                width +
                ",height=" +
                height +
    ...
    #handleTambahButtonClick(event) {
        event.preventDefault();
        const url = "/simrs/procurement/approval-po/non-pharmacy/create";
        const width = screen.width;
        const height = screen.height;
        const left = width - width / 2;
        const top = height - height / 2;
    ...
    #deleteItem(id) {
        ...
        fetch("/api/simrs/procurement/approval-po/non-pharmacy/destroy/" + id, {
            method: "DELETE",
            body: formData,
            headers: {
                "X-CSRF-TOKEN":
...
const APONPharmacyClass = new APONPharmacyHandler();
