...
(function (global, factory) {
    ...
    var error = function error(message) {
        console.log("".concat(consolePrefix, " ").concat(message));
    };
    /**
    ...
    function renderButton(button, buttonType, params) {
        toggle(
            button,
            params["showC" + buttonType.substring(1) + "Button"],
            "inline-block"
        );
    ...
    function setParameters(params) {
        ...
        if (
            !oldPopup || // If the model target has changed, refresh the popup
            (oldPopup &&
                targetElement &&
