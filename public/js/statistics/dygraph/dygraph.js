                    ...
                    (l.prototype = new r.default()),
                        ...
                        (l.prototype.onPointsCreated_ = function (t, e) {
                            for (var a = 0; a < t.length; ++a) {
                                ...
                                (n.y_top = NaN),
                                    (n.y_bottom = NaN),
                                    (n.yval_minus = r.default.parseFloat(
                                        i[2][0]
                                    )),
                                    (n.yval_plus = r.default.parseFloat(
                                        i[2][1]
                                    ));
                            }
                        }),
                        ...
                        (l.prototype.onLineEvaluated = function (t, e, a) {
                            for (var i, n = 0; n < t.length; n++)
                                (i = t[n]),
                                    (i.y_top = s.default.calcYNormal_(
                                        e,
                                        i.yval_minus,
                                        a
                                    )),
                                    (i.y_bottom = s.default.calcYNormal_(
                                        e,
                                        i.yval_plus,
                                        a
                                    ));
                ...
                function (t, e, a) {
                    ...
                    (s.prototype.clear = function () {
                        ...
                        (s.prototype._updatePoints = function () {
                            for (
                                var t = this.layout.points, e = t.length;
                                e--;
                                ...
                                for (var a = t[e], i = a.length; i--; ) {
                                    var n = a[i];
                                    (n.canvasx =
                                        this.area.w * n.x + this.area.x),
                                        (n.canvasy =
                                            this.area.h * n.y + this.area.y);
                                }
                        }),
                                    ...
                                    if (((i = s[g]), !t || i == t)) {
                                        ...
                                        r.save(),
                                            ...
                                            _({
                                                ...
                                                axis: this.dygraph_.axisPropertiesForSeries(
                                                    i
                                                ),
                                                plotArea: this.area,
                                                seriesIndex: g,
                        ...
                        (s._linePlotter = function (t) {
                            var e = t.dygraph,
                                ...
                                o =
                                    e.getOption("drawPointCallback", a) ||
                                    n.Circles.DEFAULT,
                        ...
                        (s._errorPlotter = function (t) {
                            ...
                            if (
                                ...
                                e.getBooleanOption("fillGraph", a) &&
                                    console.warn(
                                        "Can't use fillGraph option with error bars"
                                    );
                                var i,
                                    r = t.drawingContext,
                                    o = t.color,
                                ...
                                if (
                                    ...
                                    for (
                                        ...
                                        var v = t.drawingContext,
                                            y = a[_];
                                        if (
                                            e.getBooleanOption("fillGraph", y)
                                        ) {
                                            var x = e.getNumericOption(
                                                    "fillAlpha",
                                                    y
                                                ),
                                                m = e.getBooleanOption(
                                                    "stepPlot",
                                                    y
                                                ),
                                                b = p[_],
                                                w =
                                                    e.axisPropertiesForSeries(
                                                        y
                                                    ),
                ...
                function (t, e, a) {
                    ...
                    (r.prototype.draw = function (t, e) {
                        (this.container.innerHTML = ""),
                            void 0 !== this.date_graph &&
                                this.date_graph.destroy(),
                            (this.date_graph = new n.default(
                                this.container,
                                t,
                                e
                            ));
                        ...
                        (r.prototype.setSelection = function (t) {
                            var e = !1;
                            t.length && (e = t[0].row),
                                this.date_graph.setSelection(e);
                        }),
                ...
                function (t, e, a) {
                    ...
                    (r.maybeTreatMouseOpAsClick = function (t, e, a) {
                            ...
                            if (
                                (e.getOptionForAxis("logscale", "x")
                                    ? ((a.initialLeftmostDate = n.log10(o[0])),
                                      (a.dateRange =
                                          n.log10(o[1]) - n.log10(o[0])))
                                    : ((a.initialLeftmostDate = o[0]),
                                      (a.dateRange = o[1] - o[0])),
                                (a.xUnitsPerPixel =
                                    a.dateRange / (e.plotter_.area.w - 1)),
                        ...
                        (r.movePan = function (t, e, a) {
                            ...
                            a.boundedDates &&
                                (i = Math.max(i, a.boundedDates[0]));
                            var r = i + a.dateRange;
                            if (
                                (a.boundedDates &&
                                    r > a.boundedDates[1] &&
                                    ((i -= r - a.boundedDates[1]),
                                    (r = i + a.dateRange)),
                                e.getOptionForAxis("logscale", "x")
                                    ? (e.dateWindow_ = [
                        ...
                        (r.treatMouseOpAsClick = function (t, e, a) {
                            ...
                            var d =
                                t.getNumericOption("highlightCircleSize") + 2;
                        ...
                        (r.moveTouch = function (t, e, a) {
                            ...
                            o =
                                1 == n.length
                                    ...
                                    : {
                                          pageX:
                                              0.5 * (n[0].pageX + n[1].pageX),
                                          pageY:
                                              0.5 * (n[0].pageY + n[1].pageY),
                                      };
                            var h = {
                            ...
                            if (
                                (a.touchDirections.x &&
                                    ((e.dateWindow_ = [
                                        l.dataX -
                                            h.dataX +
                                            (a.initialRange.x[0] - l.dataX) / c,
                                        l.dataX -
                                            h.dataX +
                                            (a.initialRange.x[1] - l.dataX) / c,
                                    ]),
                                    (_ = !0)),
                                a.touchDirections.y)
                            )
                            ...
                            if (
                                ...
                                _ &&
                                    n.length > 1 &&
                                    e.getFunctionOption("zoomCallback"))
                            ) {
                                var x = e.xAxisRange();
                    ...
                    (r.defaultModel = {
                        ...
                        dblclick: function (t, e, a) {
                            if (a.cancelNextDblclick)
                                return void (a.cancelNextDblclick = !1);
                            var i = {
                                canvasx: a.dragEndX,
                                canvasy: a.dragEndY,
                                cancelable: !0,
                ...
                function (t, e, a) {
                    ...
                    (r.prototype.addDataset = function (t, e) {
                        ...
                        (r.prototype._evaluateLimits = function () {
                            ...
                            (this._xAxis.minval = t[0]),
                                (this._xAxis.maxval = t[1]);
                            var e = t[1] - t[0];
                            (this._xAxis.scale = 0 !== e ? 1 / e : 1),
                                this.dygraph_.getOptionForAxis(
                                    "logscale",
                                    "x"
                                ) &&
                                    ((this._xAxis.xlogrange =
                                        n.log10(this._xAxis.maxval) -
                                        n.log10(this._xAxis.minval)),
                        ...
                        (r.prototype._evaluateLineCharts = function () {
                            for (
                                var t = this.dygraph_.getOption("stackedGraph"),
                                    e = this.dygraph_.getOptionForAxis(
                                        "logscale",
                                        "x"
                                    ),
                                    a = 0;
                                ...
                                for (
                                    var i = this.points[a],
                                        n = this.setNames[a],
                                        o = this.dygraph_.getOption(
                                            "connectSeparatedPoints",
                                            n
                                        ),
                                        s =
                                            this.dygraph_.axisPropertiesForSeries(
                                                n
                                            ),
                                        l =
                                            this.dygraph_.attributes_.getForSeries(
                                                "logscale",
                                                n
                                            ),
                                        h = 0;
                        ...
                        (r.prototype._evaluateLineTicks = function () {
                            ...
                            for (
                                ...
                                (e = this.xTicks_[t]),
                                    ...
                                    (r = !("label_v" in e)),
                                    (n = r ? e.v : e.label_v),
                                    (i = this.dygraph_.toPercentXCoord(n)) >=
                                        0 &&
                                        i < 1 &&
                                        this.xticks.push({
                                            pos: i,
                            ...
                            for (
                                this.yticks = [], t = 0;
                                t < this.yAxes_.length;
                                t++
                            )
                                for (
                                    var o = this.yAxes_[t], s = 0;
                                    s < o.ticks.length;
                                    s++
                                )
                                    (e = o.ticks[s]),
                                        ...
                                        (r = !("label_v" in e)),
                                        (n = r ? e.v : e.label_v),
                                        (i = this.dygraph_.toPercentYCoord(
                                            n,
                                            t
                                        )) > 0 &&
                                            i <= 1 &&
                    ...
                    (function (i) {
                        ...
                        if (
                            ...
                            (u.axisToIndex_ = function (t) {
                                if ("string" == typeof t) {
                                    if (
                                        u.AXIS_STRING_MAPPINGS_.hasOwnProperty(
                                            t
                                        )
                                    )
                            ...
                            (u.prototype.get = function (t) {
                                ...
                                return null !== e
                                    ? e
                                    : this.getGlobalDefault_(t);
                            }),
                            (u.prototype.getGlobalUser_ = function (t) {
                                return this.user_.hasOwnProperty(t)
                                    ? this.user_[t]
                                    : null;
                            }),
                ...
                function (t, e, a) {
                    ...
                    var o = function (t, e, a, i, r, o) {
                        var s,
                            ...
                            p = [];
                        if (o)
                            for (s = 0; s < o.length; s++) p.push({ v: o[s] });
                        else {
                            if (i("logscale")) {
                                u = Math.floor(a / c);
            ...
            17: [
                function (t, e, a) {
                    ...
                    function C(t, e) {
                        ...
                        var n = function (t) {
                            for (var e in t)
                                if (t.hasOwnProperty(e) && !at[e]) return !0;
                            return !1;
                        };
                        for (var r in e)
                            if (e.hasOwnProperty(r))
                                if (
                                    "highlightSeriesOpts" == r ||
                                    (a[r] && !e.series)
                                ) {
                                    if (n(e[r])) return !0;
                    ...
                    function V(t, e, a) {
                        ...
                        return e > G.Granularity.MINUTELY
                            ? f(l, h, u, 0)
                            : f(l, h, u, d);
                    }
                    function Z(t, e) {
                        ...
                        (Q.NAME = "Dygraph"),
                            ...
                            (Q.prototype.__init__ = function (t, e, a) {
                                ...
                                (this.maindiv_ = t),
                                    (this.file_ = e),
                                    (this.rollPeriod_ =
                                        a.rollPeriod || Q.DEFAULT_ROLL_PERIOD),
                                    ...
                                    "" === t.style.height &&
                                        ...
                                        "" === t.style.width &&
                                            (t.style.width =
                                                Q.DEFAULT_WIDTH + "px")),
                                    (this.width_ =
                                        t.clientWidth || a.width || 0),
                                    (this.height_ =
                                        t.clientHeight || a.height || 0),
                                    ...
                                    (this.plugins_ = []);
                                for (
                                    var i = Q.PLUGINS.concat(
                                            this.getOption("plugins")
                                        ),
                                        n = 0;
                                    n < i.length;
                                    n++
                                ...
                                if (i)
                                    for (var n = i.length - 1; n >= 0; n--) {
                                        var r = i[n][0],
                                            o = i[n][1];
                                        if (
                                            (o.call(r, a), a.propagationStopped)
                                        )
                                            break;
                                    }
                                              ...
                                              (void 0 !== e.user_attrs_[a]
                                                  ...
                                                  : ((i = e.attrs_.axes),
                                                    ...
                                                    i[t].hasOwnProperty(a)
                                                        ? i[t][a]
                                                        : "y" == t &&
                                                          e.axes_[0].hasOwnProperty(
                                                              a
                                                          )
                                                        ? e.axes_[0][a]
                                                        : "y2" == t &&
                                                          e.axes_[1].hasOwnProperty(
                                                              a
                                                          )
                                                        ? e.axes_[1][a]
                                                        : e.attr_(a)));
                            ...
                            (Q.prototype.yAxisRange = function (t) {
                                if (
                                    (void 0 === t && (t = 0),
                                    t < 0 || t >= this.axes_.length)
                                )
                                    return null;
                                var e = this.axes_[t];
                                return [
                                    e.computedValueRange[0],
                                    e.computedValueRange[1],
                                ];
                            }),
                            ...
                            (Q.prototype.toDataXCoord = function (t) {
                                ...
                                var e = this.plotter_.area,
                                    a = this.xAxisRange();
                                if (
                                    this.attributes_.getForAxis("logscale", "x")
                                ) {
                                    var i = (t - e.x) / e.w;
                            ...
                            (Q.prototype.createInterface_ = function () {
                                ...
                                (this.graphDiv = document.createElement("div")),
                                    ...
                                    (this.hidden_ = this.createPlotKitCanvas_(
                                        this.canvas_
                                    )),
                                    (this.canvas_ctx_ = x.getContext(
                                        this.canvas_
                                    )),
                                    (this.hidden_ctx_ = x.getContext(
                                        this.hidden_
                                    )),
                            ...
                            (Q.prototype.resizeElements_ = function () {
                                (this.graphDiv.style.width =
                                    this.width_ + "px"),
                                    (this.graphDiv.style.height =
                                        this.height_ + "px");
                                var t = this.getNumericOption("pixelRatio"),
                                    e =
                                        t ||
                                        x.getContextPixelRatio(
                                            this.canvas_ctx_
                                        );
                                ...
                                var a =
                                    t ||
                                    x.getContextPixelRatio(this.hidden_ctx_);
                                (this.hidden_.width = this.width_ * a),
                                    (this.hidden_.height = this.height_ * a),
                                    (this.hidden_.style.width =
                                        this.width_ + "px"),
                                    (this.hidden_.style.height =
                                        this.height_ + "px"),
                            ...
                            (Q.prototype.createMouseEventElement_ =
                                function () {
                                    return this.canvas_;
                                }),
                            (Q.prototype.setColors_ = function () {
                                ...
                                for (
                                    ...
                                    if (o[s]) {
                                        var l = t[s + 1],
                                            h = this.attributes_.getForSeries(
                                                "color",
                                                l
                                            );
                                        if (!h)
                            ...
                            (Q.prototype.getPropertiesForSeries = function (t) {
                                ...
                                return -1 == e
                                    ...
                                    : {
                                          ...
                                          axis:
                                              1 +
                                              this.attributes_.axisForSeries(t),
                                      };
                            }),
                            (Q.prototype.createRollInterface_ = function () {
                                ...
                                var a = this.getBooleanOption("showRoller")
                                        ? "block"
                                        : "none",
                                    i = this.getArea(),
                                    n = {
                            ...
                            (Q.prototype.createDragInterface_ = function () {
                                var t = {
                                        ...
                                        initializeMouseDown: function (
                                            ...
                                            (a.px = i.x),
                                                (a.py = i.y),
                                                (a.dragStartX = x.dragGetX_(
                                                    t,
                                                    a
                                                )),
                                                (a.dragStartY = x.dragGetY_(
                                                    t,
                                                    a
                                                )),
                            ...
                            (Q.prototype.drawZoomRect_ = function (
                                t,
                                e,
                                a,
                                i,
                            ...
                            (Q.prototype.resetZoom = function () {
                                ...
                                if ((this.clearSelection(), i)) {
                                    ...
                                    var d = null,
                                        ...
                                        g = null;
                                    e &&
                                        ((d = this.xAxisRange()), (c = [o, l])),
                                        a &&
                                            ((p = this.yAxisRanges()),
                                            (g = this.yAxisExtremes())),
                                        this.doAnimatedZoom(
                                            d,
                                            c,
                                            p,
                            ...
                            (Q.prototype.doAnimatedZoom = function (
                                t,
                                e,
                                a,
                                i,
                                    ...
                                    function (t) {
                                        if (u.length)
                                            for (
                                                ...
                                                var a = u[t][e];
                                                s.axes_[e].valueRange = [
                                                    a[0],
                                                    a[1],
                                                ];
                                            }
                                        h.length && (s.dateWindow_ = h[t]),
                                            s.drawGraph_();
                                    },
                                    l,
                            ...
                            (Q.prototype.findClosestRow = function (t) {
                                for (
                                    var e = 1 / 0,
                                        a = -1,
                                        i = this.layout_.points,
                                        n = 0;
                                    n < i.length;
                                    n++
                                )
                                    for (
                                        var r = i[n], o = r.length, s = 0;
                                        s < o;
                                        s++
                                    ) {
                                        var l = r[s];
                            ...
                            (Q.prototype.findClosestPoint = function (t, e) {
                                for (
                                    ...
                                    for (
                                        var d = this.layout_.points[u], c = 0;
                                        c < d.length;
                                        ++c
                                    )
                                        (r = d[c]),
                            ...
                            (Q.prototype.getLeftBoundary_ = function (t) {
                                if (this.boundaryIds_[t])
                                    return this.boundaryIds_[t][0];
                                for (
                                    var e = 0;
                                    e < this.boundaryIds_.length;
                                    e++
                                )
                            ...
                            (Q.prototype.animateSelection_ = function (t) {
                                void 0 === this.fadeLevel &&
                                    (this.fadeLevel = 0),
                                    void 0 === this.animateId &&
                                        (this.animateId = 0);
                            ...
                            (Q.prototype.updateSelection_ = function (t) {
                                ...
                                if (this.getOption("highlightSeriesOpts")) {
                                    ...
                                    if (i) {
                                        if (void 0 === t)
                                            return void this.animateSelection_(
                                                1
                                            );
                                        (i *= t),
                                            (a.fillStyle =
                            ...
                            (Q.prototype.getSelection = function () {
                                if (
                                    !this.selPoints_ ||
                                    this.selPoints_.length < 1
                                )
                                    return -1;
                                for (
                                    var t = 0;
                                    t < this.layout_.points.length;
                                    t++
                                )
                                    for (
                                        var e = this.layout_.points[t], a = 0;
                                        a < e.length;
                                        a++
                                    )
                                        if (e[a].x == this.selPoints_[0].x)
                                            return e[a].idx;
                                return -1;
                            }),
                                ...
                                for (a = c; a >= 1; a--)
                                    if (this.visibility()[a - 1]) {
                                        ...
                                        var y = this.attr_("labels")[a],
                                            ...
                                            m =
                                                this.dataHandler_.seriesToPoints(
                                                    s,
                                                    y,
                                                    l[a - 1][0]
                                                );
                                        this.getBooleanOption("stackedGraph") &&
                                            ((o =
                                                this.attributes_.axisForSeries(
                                                    y
                                                )),
                                            void 0 === u[o] && (u[o] = []),
                                            Q.stackPoints_(
                            ...
                            (Q.prototype.computeYAxes_ = function () {
                                ...
                                for (
                                    ...
                                    (e = { g: this }),
                                        x.update(
                                            e,
                                            this.attributes_.axisOptions(t)
                                        ),
                                        (this.axes_[t] = e);
                                for (t = 0; t < this.axes_.length; t++)
                                    if (0 === t)
                                        (e = this.optionsViewForAxis_(
                                            "y" + (t ? "2" : "")
                                        )),
                                            (a = e("valueRange")) &&
                            ...
                            (Q.prototype.axisPropertiesForSeries = function (
                                t
                            ) {
                                return this.axes_[
                                    this.attributes_.axisForSeries(t)
                            ...
                            (Q.prototype.computeYAxisRanges_ = function (t) {
                                for (
                                    ...
                                    var h = this.axes_[l],
                                        u = this.attributes_.getForAxis(
                                            "logscale",
                                            l
                                        ),
                                        d = this.attributes_.getForAxis(
                                            "includeZero",
                                            l
                                        ),
                                        c = this.attributes_.getForAxis(
                                            "independentTicks",
                                            l
                                        );
                                    (i = this.attributes_.seriesForAxis(l)),
                                        (e = !0),
                                        (n = 0.1);
                                    ...
                                    if (c) {
                                        ...
                                        var E = this.optionsViewForAxis_(
                                                "y" + (l ? "2" : "")
                                            ),
                                            L = E("ticker");
                                        (h.ticks = L(
                                    ...
                                    if (!h.independentTicks) {
                                        for (
                                            var E = this.optionsViewForAxis_(
                                                ...
                                                T = r.ticks,
                                                S =
                                                    r.computedValueRange[1] -
                                                    r.computedValueRange[0],
                                                P =
                                                    h.computedValueRange[1] -
                                                    h.computedValueRange[0],
                                                C = [],
                            ...
                            (Q.prototype.setXAxisOptions_ = function (t) {
                                t
                                    ...
                                    : ((this.attrs_.xValueParser = function (
                                          t
                                      ) {
                                          return parseFloat(t);
                                      }),
                            ...
                            (Q.prototype.parseArray_ = function (t) {
                                ...
                                if (0 === t[0].length)
                                    return (
                                        console.log(
                                            "Data set cannot contain an empty row"
                                        ),
                                        null
                                    );
                                o(t);
                            ...
                            (Q.prototype.cascadeDataDidUpdateEvent_ =
                                function () {
                            ...
                            (Q.prototype.updateOptions = function (t, e) {
                                ...
                                "rollPeriod" in i &&
                                    (this.rollPeriod_ = i.rollPeriod),
                                    "dateWindow" in i &&
                                        (this.dateWindow_ = i.dateWindow);
                                var n = x.isPixelChangingOptionList(
                                    this.attr_("labels"),
                                    i
                                );
                                ...
                                if (!this.resize_lock) {
                                    ...
                                    t
                                        ? ((this.maindiv_.style.width =
                                          ...
                                          (this.height_ = e))
                                        : ((this.width_ =
                                              this.maindiv_.clientWidth),
                                          (this.height_ =
                                              this.maindiv_.clientHeight)),
                                        (a == this.width_ &&
                                            i == this.height_) ||
                                            (this.resizeElements_(),
                                            this.predraw_()),
                                ...
                                if (
                                    ...
                                    for (var n in t)
                                        t.hasOwnProperty(n) &&
                                            (n < 0 || n >= a.length
                                                ? console.warn(
                                                      "Invalid series number in setVisibility: " +
                                                          n
                                                  )
                                                : (a[n] = t[n]));
                                else
                            ...
                            (Q.prototype.removeTrackedEvents_ = function () {
                                if (this.registeredEvents_)
                                    for (
                                        var t = 0;
                                        t < this.registeredEvents_.length;
                                        t++
                                    ) {
                            ...
                            (Q.defaultInteractionModel =
                                f.default.defaultModel),
                    ...
                    (i.prototype.cover = function () {
                        ...
                        (i.prototype.uncover = function () {
                            for (var t = 0; t < this.tarps.length; t++)
                                this.tarps[t].parentNode.removeChild(
                                    this.tarps[t]
                                );
                            this.tarps = [];
                        }),
                            ...
                            if (a && 0 !== a.length)
                                for (
                                    ...
                                    if (
                                        ...
                                        var h = l.annotation,
                                            u = 6;
                                        h.hasOwnProperty("tickHeight") &&
                                            (u = h.tickHeight);
                                        var d = document.createElement("div");
                                        d.style.fontSize =
                                            e.getOption("axisLabelFontSize") +
                                            "px";
                                        var c = "dygraph-annotation";
                                        h.hasOwnProperty("icon") ||
                                            (c +=
                                                " dygraphDefaultAnnotation dygraph-default-annotation"),
                                            h.hasOwnProperty("cssClass") &&
                                                (c += " " + h.cssClass),
                                            (d.className = c);
                                        var p = h.hasOwnProperty("width")
                                                ? h.width
                                                : 16,
                                            g = h.hasOwnProperty("height")
                                                ? h.height
                                                : 16;
                                        if (h.hasOwnProperty("icon")) {
                                            ...
                                            l.annotation.hasOwnProperty(
                                                "shortText"
                                            ) &&
                                                d.appendChild(
                                                    document.createTextNode(
                                                        l.annotation.shortText
                                                    )
                                                );
                                        var _ = l.canvasx - p / 2;
                                        d.style.left = _ + "px";
                                        ...
                                        if (
                                            (x.save(),
                                            (x.strokeStyle = h.hasOwnProperty(
                                                "tickColor"
                                            )
                                                ? h.tickColor
                                                : e.colorsMap_[l.name]),
                                            (x.lineWidth = h.hasOwnProperty(
                                                "tickWidth"
                                            )
                                                ? h.tickWidth
                                            ...
                                            var y = v + g;
                                            x.moveTo(l.canvasx, y),
                                                x.lineTo(l.canvasx, y + u);
                                        } else
                            ...
                            if (
                                ...
                                if (r.getOptionForAxis("drawAxis", "y")) {
                                    ...
                                    (h.strokeStyle = r.getOptionForAxis(
                                        ...
                                        (h.lineWidth = r.getOptionForAxis(
                                            "axisLineWidth",
                                            "y"
                                        )),
                                        h.beginPath(),
                ...
                function (t, e, a) {
                    ...
                    (i.prototype.layout = function (t) {
                        ...
                        if (e.getOption("title")) {
                            var i = t.reserveSpaceTop(
                                e.getOption("titleHeight")
                            );
                            (this.title_div_ = n(i)),
                        ...
                        if (e.getOption("xlabel")) {
                            var s = t.reserveSpaceBottom(
                                e.getOption("xLabelHeight")
                            );
                        ...
                        (i.prototype.didDrawChart = function (t) {
                            var e = t.dygraph;
                            this.title_div_ &&
                                (this.title_div_.children[0].innerHTML =
                                    e.getOption("title")),
                                this.xlabel_div_ &&
                        ...
                        (i.prototype.willDrawChart = function (t) {
                            ...
                            if (s.getOptionForAxis("drawGrid", "y")) {
                                for (
                                    ...
                                    (g[r] = s.getOptionForAxis(
                                        "drawGrid",
                                        d[r]
                                    )),
                                        g[r] &&
                                            ((c[r] = s.getOptionForAxis(
                                                "gridLineColor",
                                                d[r]
                                            )),
                                            (p[r] = s.getOptionForAxis(
                                                "gridLineWidth",
                                                d[r]
                                            )),
                                            (_[r] = s.getOptionForAxis(
                                                "gridLinePattern",
                                                d[r]
                                            )),
                            ...
                            if (s.getOptionForAxis("drawGrid", "x")) {
                                (o = h.xticks), l.save();
                                var _ = s.getOptionForAxis(
                                        "gridLinePattern",
                                        "x"
                                    ),
                                    f = _ && _.length >= 2;
                                f && l.setLineDash && l.setLineDash(_),
                                    (l.strokeStyle = s.getOptionForAxis(
                                        "gridLineColor",
                                        "x"
                                    )),
                                    (l.lineWidth = s.getOptionForAxis(
                                        "gridLineWidth",
                                        "x"
                                    )),
                                    o.forEach(function (t) {
            ...
            24: [
                function (t, e, a) {
                    ...
                    (o.prototype.select = function (t) {
                        ...
                        if ("never" === n)
                            return void (this.legend_div_.style.display =
                                "none");
                        if ("follow" === n) {
                            var r = t.dygraph.plotter_.area,
                                s = this.legend_div_.offsetWidth,
                                l = t.dygraph.getOptionForAxis(
                                    "axisLabelWidth",
                                    "y"
                                ),
                                h = a[0].x * r.w + 50,
                            ...
                            h + s + 1 > r.w && (h = h - 100 - s - (l - r.x)),
                                t.dygraph.graphDiv.appendChild(
                                    this.legend_div_
                                ),
                        ...
                        (o.generateLegendHTML = function (t, e, a, n, s) {
                            ...
                            if (void 0 !== e) {
                                ...
                                for (
                                    var y = [], x = t.numAxes(), c = 0;
                                    c < x;
                                    c++
                                )
                                    y[c] = t.optionsViewForAxis_(
                                        "y" + (c ? 1 + c : "")
                                    );
                                ...
                                for (c = 0; c < a.length; c++) {
                                    ...
                                    if (
                                        ...
                                        var p = t.getPropertiesForSeries(
                                                w.name
                                            ),
                                            A = y[p.axis - 1],
                                            O = A("valueFormatter"),
                            ...
                            return (
                                t.getOption("legendFormatter") ||
                                o.defaultFormatter
                            ).call(t, h);
                        }),
                        (o.defaultFormatter = function (t) {
                            var e = t.dygraph;
                            if (!0 !== e.getOption("showLabelsOnHighlight"))
                                return "";
                            var a,
                                i = e.getOption("labelsSeparateLines");
                            if (void 0 === t.x) {
                                if ("always" != e.getOption("legend"))
                                    return "";
                                a = "";
                ...
                function (t, e, a) {
                    ...
                    (u.prototype.toString = function () {
                        ...
                        (u.prototype.resize_ = function () {
                            ...
                            var i =
                                this.dygraph_.getNumericOption("pixelRatio");
                            t(
                                this.bgcanvas_,
                                this.bgcanvas_ctx_,
                                this.canvasRect_,
                        ...
                        (u.prototype.createCanvases_ = function () {
                            (this.bgcanvas_ = r.createCanvas()),
                                (this.bgcanvas_.className =
                                    "dygraph-rangesel-bgcanvas"),
                                (this.bgcanvas_.style.position = "absolute"),
                                (this.bgcanvas_.style.zIndex = 9),
                                (this.bgcanvas_ctx_ = r.getContext(
                                    this.bgcanvas_
                                )),
                                (this.fgcanvas_ = r.createCanvas()),
                                (this.fgcanvas_.className =
                                    "dygraph-rangesel-fgcanvas"),
                                (this.fgcanvas_.style.position = "absolute"),
                                (this.fgcanvas_.style.zIndex = 9),
                                (this.fgcanvas_.style.cursor = "default"),
                                (this.fgcanvas_ctx_ = r.getContext(
                                    this.fgcanvas_
                                ));
                        }),
                        ...
                        (u.prototype.initInteraction_ = function () {
                            ...
                            (t = function (t) {
                                ...
                                return [
                                    e[0] +
                                        (t.leftHandlePos - v.canvasRect_.x) * a,
                                    e[0] +
                                        (t.rightHandlePos - v.canvasRect_.x) *
                                            a,
                                ];
                            }),
                                (e = function (t) {
                                ...
                                (a = function (t) {
                                    ...
                                    m == v.leftZoomHandle_
                                        ? ((a = i.leftHandlePos + e),
                                          (a = Math.min(
                                              a,
                                              i.rightHandlePos - m.width - 3
                                          )),
                                          (a = Math.max(a, v.canvasRect_.x)))
                                        : ((a = i.rightHandlePos + e),
                                          (a = Math.min(
                                              a,
                                              v.canvasRect_.x + v.canvasRect_.w
                                          )),
                                          (a = Math.max(
                                              a,
                                              i.leftHandlePos + m.width + 3
                                          )));
                                    var o = m.width / 2;
                                    return (
                                        (m.style.left = a - o + "px"),
                                ...
                                (o = function (t) {
                                    var e =
                                            v.leftZoomHandle_.getBoundingClientRect(),
                                        a = e.left + e.width / 2;
                                    e =
                                ...
                                (l = function (t) {
                                    return (
                                        !(
                                            w ||
                                            !o(t) ||
                                            !v.getZoomHandleStatus_().isZoomed
                                        ) &&
                                        (r.cancelEvent(t),
                                        (w = !0),
                                        (x = t.clientX),
                                ...
                                (u = function (t) {
                                    ...
                                    return (
                                        (v.leftZoomHandle_.style.left =
                                            i - s + "px"),
                                        (v.rightZoomHandle_.style.left =
                                            n - s + "px"),
                                        v.drawInteractiveLayer_(),
                                        A && c(),
                                        !0
                                ...
                                (c = function () {
                                    try {
                                        (v.isChangingRange_ = !0),
                                            (v.dygraph_.dateWindow_ = t(
                                                v.getZoomHandleStatus_()
                                            )),
                        ...
                        (u.prototype.drawStaticLayer_ = function () {
                            ...
                            (this.bgcanvas_ctx_.lineWidth = this.getOption_(
                                ...
                                t.lineTo(
                                    this.canvasRect_.w - 0.5,
                                    this.canvasRect_.h - 0.5
                                ),
                        ...
                        (u.prototype.drawMiniPlot_ = function () {
                            ...
                            if (t || a) {
                                ...
                                if ((o.lineTo(d, c), o.closePath(), t)) {
                                    var x =
                                        this.bgcanvas_ctx_.createLinearGradient(
                                            0,
                                            0,
                                            0,
                                            c
                        ...
                        (u.prototype.computeCombinedSeriesAndLimits_ =
                            function () {
                                var t,
                                    e = this.dygraph_,
                        ...
                        (u.prototype.placeZoomHandles_ = function () {
                            var t = this.dygraph_.xAxisExtremes(),
                                ...
                                o =
                                    this.canvasRect_.x +
                                    this.canvasRect_.w * (1 - n),
                                s = Math.max(
                                    this.canvasRect_.y,
                                    this.canvasRect_.y +
                                        (this.canvasRect_.h -
                                            this.leftZoomHandle_.height) /
                                            2
                                ),
                            ...
                            (this.leftZoomHandle_.style.left = r - l + "px"),
                                ...
                                (this.leftZoomHandle_.style.visibility =
                                    "visible"),
                                (this.rightZoomHandle_.style.visibility =
                                    "visible");
                        }),
                        (u.prototype.drawInteractiveLayer_ = function () {
                            ...
                            if (
                                ...
                                var n = Math.max(
                                        1,
                                        i.leftHandlePos - this.canvasRect_.x
                                    ),
                                    r = Math.min(
                                        e,
                                        i.rightHandlePos - this.canvasRect_.x
                                    );
                                (t.fillStyle =
                                    "rgba(240, 240, 240, " +
                                    this.getOption_(
                        ...
                        (u.prototype.getZoomHandleStatus_ = function () {
                            ...
                            return {
                                ...
                                isZoomed:
                                    ...
                                    a + 1 <
                                        this.canvasRect_.x + this.canvasRect_.w,
                            };
                        }),
                        (a.default = u),
                        (e.exports = a.default);
