...
(function (global, factory) {
    ...
    AxisInternal.prototype.tspanData = function (d, i, scale) {
        ...
        if (
            internal.params.tickMultiline &&
            internal.params.tickMultilineMax > 0
        ) {
            splitted = internal.ellipsify(
                splitted,
                internal.params.tickMultilineMax
            );
        }
        ...
        function split(splitted, text) {
            ...
            for (var i = 1; i < text.length; i++) {
                ...
                if (maxWidth < textWidth) {
                    return split(
                        splitted.concat(
                            text.substr(0, spaceIndex ? spaceIndex : i)
                        ),
    ...
    AxisInternal.prototype.lineY2 = function (d) {
        var internal = this,
            tickPosition =
                internal.scale(d) +
                (internal.tickCentered ? 0 : internal.tickOffset);
        return internal.range[0] < tickPosition &&
            tickPosition < internal.range[1]
    ...
    AxisInternal.prototype.generateAxis = function () {
        ...
        function axis(g, transition) {
            ...
            g.each(function () {
                ...
                self = (
                    transition ? tickUpdate.transition(transition) : tickUpdate
                )
                    .style("opacity", 1)
    ...
    Axis.prototype.getXAxis = function getXAxis(
        ...
        var $$ = this.owner,
            ...
            axisParams = {
                ...
                tickTextRotate: withoutRotateTickText
                    ? 0
                    : config.axis_x_tick_rotate,
        ...
        if (config.axis_x_tick_format) {
            if (isFunction(config.axis_x_tick_format)) {
                ...
                format = function format(date) {
                    return date
                        ? $$.axisTimeFormat(config.axis_x_tick_format)(date)
                        : "";
                };
            }
        }
    ...
    Axis.prototype.getLabelPosition = function getLabelPosition(
        ...
        var option = this.getLabelOptionByAxisId(axisId),
            position =
                option && _typeof(option) === "object" && option.position
                    ? option.position
                    : defaultPosition;
        return {
    ...
    Axis.prototype.dyForXAxisLabel = function dyForXAxisLabel() {
        ...
        if (config.axis_rotated) {
            return position.isInner
                ? "1.2em"
                : -25 -
                      ($$.config.axis_x_inner ? 0 : this.getMaxTickWidth("x"));
        } else {
            return position.isInner
                ? "-0.5em"
    ...
    Axis.prototype.textAnchorForXAxisLabel =
    ...
    Axis.prototype.textAnchorForYAxisLabel =
    ...
    Axis.prototype.updateLabels = function updateLabels(withTransition) {
        ...
        var axisXLabel = $$.main.select(
            ...
            axisYLabel = $$.main.select(
                "." + CLASS.axisY + " ." + CLASS.axisYLabel
            ),
        ...
        if (tickCount) {
            ...
            if (targetCount === 1) {
                ...
                for (i = 0; i < count; i++) {
                    ...
                    tickValues.push(
                        forTimeSeries ? new Date(tickValue) : tickValue
                    );
                }
    ...
    Axis.prototype.generateTransitions = function generateTransitions(
        duration
    ) {
        var $$ = this.owner,
            axes = $$.axes;
        return {
            ...
            axisY2: duration
                ? axes.y2.transition().duration(duration)
                : axes.y2,
            axisSubX: duration
    ...
    ChartInternal.prototype.init = function () {
        ...
        if (config.data_url) {
            ...
            $$.initWithData(
                $$.convertJsonToData(config.data_json, config.data_keys)
            );
    ...
    ChartInternal.prototype.initParams = function () {
        ...
        $$.dataTimeParse = (
            config.data_xLocaltime ? d3.timeParse : d3.utcParse
        )($$.config.data_xFormat);
    ...
    ChartInternal.prototype.updateSizes = function () {
        ...
        $$.margin2 = config.axis_rotated
            ...
            : {
                  top:
                      $$.currentHeight - subchartHeight - legendHeightForBottom,
                  right: NaN,
    ...
    ChartInternal.prototype.redraw = function (options, transitions) {
        ...
        withUpdateOrgXDomain = getOption(
            options,
            "withUpdateOrgXDomain",
            false
        );
        withTrimXDomain = getOption(options, "withTrimXDomain", true);
        withUpdateXAxis = getOption(
            options,
            "withUpdateXAxis",
            withUpdateXDomain
        );
        ...
        transitions =
            transitions || $$.axis.generateTransitions(durationForAxis); // update legend and transform each g
        ...
        drawArea = $$.generateDrawArea
            ...
            : undefined;
        drawBar = $$.generateDrawBar
            ? $$.generateDrawBar(barIndices)
            : undefined;
    ...
    ChartInternal.prototype.updateAndRedraw = function (options) {
        ...
        options.withUpdateXDomain = getOption(
            options,
            "withUpdateXDomain",
            true
        );
    ...
    ChartInternal.prototype.isCustomX = function () {
        var $$ = this,
            config = $$.config;
        return (
            !$$.isTimeSeries() && (config.data_x || notEmpty(config.data_xs))
        );
    };
    ...
    ChartInternal.prototype.updateSvgSize = function () {
        ...
        $$.svg
            ...
            .select("rect")
            .attr("width", $$.width)
            .attr("height", brush.size() ? brush.attr("height") : 0); // MEMO: parent div's height will be bigger than svg when <!DOCTYPE html>
    ...
    ChartInternal.prototype.observeInserted = function (selection) {
        ...
        if (typeof MutationObserver === "undefined") {
            window.console.log("MutationObserver not defined.");
            return;
        }
    ...
    ChartInternal.prototype.parseDate = function (date) {
        ...
        if (!parsedDate || isNaN(+parsedDate)) {
            window.console.log(
                "Failed to parse x '" + date + "' to Date object"
            );
        }
    ...
    (function () {
        if (!("SVGPathSeg" in window)) {
            ...
            window.SVGPathSegLinetoHorizontalAbs = function (
                owningPathSegList,
                x
            ) {
                window.SVGPathSeg.call(
            ...
            window.SVGPathSegLinetoHorizontalRel = function (
                owningPathSegList,
                x
            ) {
                window.SVGPathSeg.call(
            ...
            window.SVGPathSegLinetoVerticalAbs = function (
                owningPathSegList,
                y
            ) {
                window.SVGPathSeg.call(
            ...
            window.SVGPathSegLinetoVerticalRel = function (
                owningPathSegList,
                y
            ) {
                window.SVGPathSeg.call(
            ...
            if (!("getPathSegAtLength" in window.SVGPathElement.prototype)) {
                ...
                window.SVGPathElement.prototype.getPathSegAtLength = function (
                    ...
                    var lastPathSegment =
                        measurementElement.pathSegList.numberOfItems - 1; // If the path is empty, return 0.

                    if (lastPathSegment <= 0) return 0;

                    do {
                        measurementElement.pathSegList.removeItem(
                            lastPathSegment
                        );
        ...
        if (!("SVGPathSegList" in window)) {
            ...
            window.SVGPathSegList._pathSegArrayAsString = function (
                pathSegArray
            ) {
                var string = "";
                var first = true;
                ...
                Source.prototype.parseSegment = function () {
                    ...
                    if (command == window.SVGPathSeg.PATHSEG_UNKNOWN) {
                        ...
                        if (
                            ...
                            return null;
                        command = this._nextCommandHelper(
                            lookahead,
                            this._previousCommand
                        );
                        if (command == window.SVGPathSeg.PATHSEG_UNKNOWN)
                    ...
                    switch (command) {
                        ...
                        case window.SVGPathSeg.PATHSEG_CLOSEPATH:
                            ...
                            return new window.SVGPathSegClosePath(
                                owningPathSegList
                            );
        ...
        if (!orgDataCount) {
            if ($$.isTimeSeries()) {
                if (baseTarget.values.length > 1) {
                    diff =
                        baseTarget.values[baseTarget.values.length - 1].x -
                        baseValue.x;
                } else {
    ...
    ChartInternal.prototype.generateFlow = function (args) {
        ...
        return function () {
            ...
            transform =
                "translate(" + translateX + ",0) scale(" + scaleX + ",1)";
            $$.hideXGridFocus();
            ...
            wait.add(
                mainBar.transition(flowTransition).attr("transform", transform)
            );
            wait.add(
            ...
            wait.add(
                xgrid.transition(flowTransition).attr("transform", transform)
            );
            wait.add(
                xgridLines
                    .transition(flowTransition)
    ...
    Chart.prototype.selected = function (targetId) {
        ...
        return $$.main
            .selectAll(
                "." + CLASS.shapes + $$.getTargetSelectorSuffix(targetId)
            )
            ...
            .each(function (d, i) {
                ...
                if (isTargetId && isTargetIndex) {
                    ...
                    if (isSelected) {
                        toggle(
                            false,
                            shape.classed(CLASS.SELECTED, false),
                            d,
                            i
                        );
                    }
    ...
    ChartInternal.prototype.updateAngle = function (d) {
        ...
        if ($$.isGaugeType(d.data)) {
            ...
            gTic =
                (Math.PI * (config.gauge_fullCircle ? 2 : 1)) / (gMax - gMin);
            gValue =
                d.value < gMin
                    ? 0
                    : d.value < gMax
    ...
    ChartInternal.prototype.transformForArcLabel = function (d) {
        ...
        if (updated && !hasGauge) {
            ...
            x =
                Math.cos(updated.endAngle - Math.PI / 2) *
                ($$.radiusExpanded + 25);
    ...
    ChartInternal.prototype.getArcRatio = function (d) {
        var $$ = this,
            ...
            whole =
                Math.PI *
                ($$.hasType("gauge") && !config.gauge_fullCircle ? 1 : 2);
        ...
        if ($$.transiting) {
            interval = window.setInterval(function () {
                if (!$$.transiting) {
                    ...
                    if (
                        $$.legend.selectAll(".c3-legend-item-focused").size() >
                        0
                    ) {
                        $$.expandArc(targetIds);
                    }
    ...
    ChartInternal.prototype.redrawArc = function (
                            ...
                            var updated = $$.updateAngle(d),
                                ...
                                linePositioningAngle =
                                    ...
                                    (arcInnerRadius === 0
                                        ...
                                        : 1 / arcInnerRadius);
                            lineLength =
                                $$.radiusExpanded - $$.radius + innerLineLength;
        ...
        mainArc
            .attr("transform", function (d) {
                return !$$.isGaugeType(d.data) && withTransform
                    ? "scale(0)"
                    : "";
            })
            .on(
        ...
        main.selectAll("." + CLASS.chartArc)
            ...
            .style("opacity", function (d) {
                return $$.isTargetToShow(d.data.id) && $$.isArcType(d.data)
                    ? 1
                    : 0;
            });
        main.select("." + CLASS.chartArcsTitle).style(
            "opacity",
            $$.hasType("donut") || hasGaugeType ? 1 : 0
        );
    ...
    ChartInternal.prototype.classArc = function (d) {
        return (
            this.classShape(d.data) + this.generateClass(CLASS.arc, d.data.id)
        );
    };

    ChartInternal.prototype.classArcs = function (d) {
        return (
            this.classShapes(d.data) + this.generateClass(CLASS.arcs, d.data.id)
        );
    };
    ...
    ChartInternal.prototype.selectorTarget = function (id, prefix) {
        return (
            ...
            "." +
            CLASS.target +
            this.getTargetSelectorSuffix(id)
        );
    };
    ...
    ChartInternal.prototype.getClipPath = function (id) {
        ...
        return (
            "url(" + (isIE9 ? "" : document.URL.split("#")[0]) + "#" + id + ")"
        );
    };
    ...
    ChartInternal.prototype.generateLevelColor = function () {
        var $$ = this,
            ...
            values =
                threshold.values && threshold.values.length
                    ? threshold.values
                    : [],
    ...
    ChartInternal.prototype.getDefaultConfig = function () {
        var config = {
            ...
            data_selection_isselectable:
                function data_selection_isselectable() {
                    return true;
                },
                ...
                values: data
                    .map(function (d, i) {
                        var xKey = $$.getXKey(id),
                            rawX = d[xKey],
                            value =
                                d[id] !== null && !isNaN(d[id]) ? +d[id] : null,
                            x,
    ...
    ChartInternal.prototype.addHiddenTargetIds = function (targetIds) {
        targetIds =
            targetIds instanceof Array ? targetIds : new Array(targetIds);

        for (var i = 0; i < targetIds.length; i++) {
            if (this.hiddenTargetIds.indexOf(targetIds[i]) < 0) {
                this.hiddenTargetIds = this.hiddenTargetIds.concat(
                    targetIds[i]
                );
            }
        }
    ...
    ChartInternal.prototype.addHiddenLegendIds = function (targetIds) {
        ...
        for (var i = 0; i < targetIds.length; i++) {
            if (this.hiddenLegendIds.indexOf(targetIds[i]) < 0) {
                this.hiddenLegendIds = this.hiddenLegendIds.concat(
                    targetIds[i]
                );
            }
        }
    ...
    ChartInternal.prototype.findClosest = function (values, pos) {
        ...
        values
            ...
            .forEach(function (v) {
                var d = $$.config.tooltip_horizontal
                    ? $$.horizontalDistance(v, pos)
                    : $$.dist(v, pos);
        ...
        if (args.data) {
            ...
            $$.load(
                $$.convertDataToTargets(
                    $$.convertJsonToData(args.json, args.keys)
                ),
                args
            );
        } else if (args.rows) {
            $$.load(
                $$.convertDataToTargets($$.convertRowsToData(args.rows)),
                args
            );
        } else if (args.columns) {
            $$.load(
    ...
    ChartInternal.prototype.unload = function (targetIds, done) {
        ...
        targetIds.forEach(function (id) {
            ...
            if ($$.legend) {
                $$.legend
                    .selectAll(
                        "." + CLASS.legendItem + $$.getTargetSelectorSuffix(id)
                    )
                    .remove();
            } // Remove target
    ...
    ChartInternal.prototype.getYDomain = function (targets, axisId, xDomain) {
        var $$ = this,
            ...
            padding_bottom,
            center =
                axisId === "y2" ? config.axis_y2_center : config.axis_y_center,
            yDomainAbs,
            lengths,
            diff,
            ratio,
            ...
            isInverted =
                axisId === "y2"
                    ? config.axis_y2_inverted
                    : config.axis_y_inverted,
        ...
        if (
            (isValue(yMin) && isAllPositive) ||
            (isValue(yMax) && isAllNegative)
        ) {
            isZeroBased = false;
        ...
        if (showHorizontalDataLabel) {
            ...
            padding_top +=
                domainLength * (ratio[1] / (1 - ratio[0] - ratio[1]));
            padding_bottom +=
                domainLength * (ratio[0] / (1 - ratio[0] - ratio[1]));
    ...
    ChartInternal.prototype.updateYGrid = function () {
        var $$ = this,
            config = $$.config,
            gridValues =
                $$.yAxis.tickValues() || $$.y.ticks(config.grid_y_ticks);
        var ygrid = $$.main
            .select("." + CLASS.ygrids)
        ...
        if (config.zoom_enabled && $$.zoom) {
            ...
            if (config.zoom_initialRange) {
                ...
                $$.eventRect
                    ...
                    .call(
                        $$.zoom.transform,
                        $$.zoomTransform(config.zoom_initialRange)
                    );
            }
        }
    };
            ...
            .on(
                ...
                config.interaction_enabled
                    ? function () {
                          ...
                          targetsToShow = $$.filterTargetsToShow(
                              $$.data.targets
                          );
                          mouse = d3.mouse(this);
                          closest = $$.findClosestFromTargets(
                              targetsToShow,
                              mouse
                          );
                          ...
                          if (
                              $$.isScatterOrStanfordType(closest) ||
    ...
    ChartInternal.prototype.updateLegend = function (
        ...
        targetIds = targetIds.filter(function (id) {
            return (
                !isDefined(config.data_names[id]) ||
                config.data_names[id] !== null
            );
        });
        options = options || {};
        withTransition = getOption(options, "withTransition", true);
        ...
        function updatePositions(textElement, id, index) {
            ...
            maxLength =
                $$.isLegendRight || $$.isLegendInset ? maxHeight : maxWidth;
        ...
        l.append("text")
            ...
            .attr(
                "x",
                $$.isLegendRight || $$.isLegendInset ? xForLegendText : -200
            )
            .attr(
                "y",
                $$.isLegendRight || $$.isLegendInset ? -200 : yForLegendText
            );
        l.append("rect")
            ...
            .attr(
                "x",
                $$.isLegendRight || $$.isLegendInset ? xForLegendRect : -200
            )
            .attr(
                "y",
                $$.isLegendRight || $$.isLegendInset ? -200 : yForLegendRect
            );
        l.append("line")
            ...
            .attr(
                "x1",
                $$.isLegendRight || $$.isLegendInset ? x1ForLegendTile : -200
            )
            .attr(
                "y1",
                $$.isLegendRight || $$.isLegendInset ? -200 : yForLegendTile
            )
            .attr(
                "x2",
                $$.isLegendRight || $$.isLegendInset ? x2ForLegendTile : -200
            )
            .attr(
                "y2",
                $$.isLegendRight || $$.isLegendInset ? -200 : yForLegendTile
    ...
    ChartInternal.prototype.redrawRegion = function (
        withTransition,
        transition
    ) {
        var $$ = this,
    ...
    ChartInternal.prototype.getScale = function (min, max, forTimeseries) {
        return (
            forTimeseries ? this.d3.scaleTime() : this.d3.scaleLinear()
        ).range([min, max]);
    };
    ...
    ChartInternal.prototype.selectPoint = function (target, d, i) {
        ...
        $$.main
            .select(
                "." + CLASS.selectedCircles + $$.getTargetSelectorSuffix(d.id)
            )
    ...
    ChartInternal.prototype.togglePath = function (selected, target, d, i) {
        selected
            ? this.selectPath(target, d, i)
            : this.unselectPath(target, d, i);
    };
    ...
    ChartInternal.prototype.redrawBar = function (
        ...
        return [
            (withTransition
                ? this.mainBar.transition(transition)
                : this.mainBar
            )
                .attr("d", drawBar)
        ...
        var $$ = this,
            ...
            w =
                typeof config.bar_width === "number"
                    ? config.bar_width
                    : barTargetsNum
                    ? (axis.tickInterval() * config.bar_width_ratio) /
                      barTargetsNum
                    : 0;
    ...
    ChartInternal.prototype.getBars = function (i, id) {
        ...
        return (
            id
                ? $$.main.selectAll(
                      "." + CLASS.bars + $$.getTargetSelectorSuffix(id)
                  )
                : $$.main
    ...
    ChartInternal.prototype.generateGetBarPoints = function (
        barIndices,
        isSub
    ) {
        var $$ = this,
    ...
    ChartInternal.prototype.redrawLine = function (
        ...
        return [
            (withTransition
                ? this.mainLine.transition(transition)
                : this.mainLine
            )
                .attr("d", drawLine)
                .style("stroke", this.color)
        ...
        return function (d) {
            ...
            if ($$.isLineType(d)) {
                if (config.data_regions[d.id]) {
                    path = $$.lineWithRegions(
                        values,
                        x,
                        y,
                        config.data_regions[d.id]
                    );
                } else {
                    if ($$.isStepType(d)) {
    ...
    ChartInternal.prototype.redrawArea = function (
        ...
        return [
            (withTransition
                ? this.mainArea.transition(transition)
                : this.mainArea
            )
                .attr("d", drawArea)
                .style("fill", this.color)
    ...
    ChartInternal.prototype.redrawCircle = function (
        ...
        return [
            (withTransition
                ? $$.mainCircle.transition(transition)
                : $$.mainCircle
            )
    ...
    ChartInternal.prototype.isWithinCircle = function (that, r) {
        var d3 = this.d3,
            ...
            cy = +d3_this.attr("cy");
        return (
            Math.sqrt(Math.pow(cx - mouse[0], 2) + Math.pow(cy - mouse[1], 2)) <
            r
        );
    };
    ...
    ChartInternal.prototype.getCurrentPaddingLeft = function (
        ...
        if (isValue(config.padding_left)) {
            ...
            return !config.axis_x_show || config.axis_x_inner
                ? 1
                : Math.max(
                      ceil10($$.getAxisWidthByAxisId("x", withoutRecompute)),
                      40
                  );
    ...
    ChartInternal.prototype.getCurrentPaddingRight = function () {
        var $$ = this,
            ...
            padding = 0,
            defaultPadding = 10,
            legendWidthOnRight = $$.isLegendRight
                ? $$.getLegendWidth() + 20
                : 0;
    ...
    ChartInternal.prototype.getSvgLeft = function (withoutRecompute) {
        var $$ = this,
            ...
            hasLeftAxisRect =
                config.axis_rotated ||
                (!config.axis_rotated && !config.axis_y_inner),
    ...
    ChartInternal.prototype.getHorizontalAxisHeight = function (axisId) {
        ...
        if (
            ...
            h =
                ...
                $$.axis.getMaxTickWidth(axisId) *
                    Math.cos(
                        (Math.PI * (90 - Math.abs(config.axis_x_tick_rotate))) /
                            180
                    );
        ...
        if (
            ...
            h =
                ...
                $$.axis.getMaxTickWidth(axisId) *
                    Math.cos(
                        (Math.PI * (90 - Math.abs(config.axis_y_tick_rotate))) /
                            180
                    );
        }
    ...
    ChartInternal.prototype.initBrush = function (scale) {
        ...
        $$.brush.selection = function () {
            return d3.brushSelection(
                $$.context.select("." + CLASS.brush).node()
            );
        };
        ...
        $$.brush.selectionAsValue = function (
            ...
            return [
                this.scale.invert(selection[0]),
                this.scale.invert(selection[1]),
            ];
        };
    ...
    ChartInternal.prototype.redrawSubchart = function (
        ...
        $$.context.style(
            "visibility",
            config.subchart_show ? "visible" : "hidden"
        ); // subchart
    ...
    ChartInternal.prototype.getDefaultSelection = function () {
        ...
        if ($$.isTimeSeries()) {
            selection = [
                $$.parseDate(selection[0]),
                $$.parseDate(selection[1]),
            ];
        }
    ...
    ChartInternal.prototype.redrawText = function (
        ...
        return [
            (withTransition
                ? this.mainText.transition(transition)
                : this.mainText
            )
                .attr("x", xForText)
                .attr("y", yForText)
                ...
                .style(
                    "fill-opacity",
                    forFlow ? 0 : this.opacityForText.bind(this)
                ),
        ];
    };
    ...
    ChartInternal.prototype.drawColorScale = function () {
        ...
        height =
            $$.height -
            config.stanford_padding.bottom -
        ...
        $$.colorScale
            ...
            .attr(
                "transform",
                "translate(0, ".concat(config.stanford_padding.top, ")")
            )
            .selectAll("bars")
            .data(points)
            .enter()
        ...
        $$.colorScale.attr(
            "transform",
            "translate(".concat($$.currentWidth - $$.xForColorScale(), ", 0)")
        );
    };
    ...
    ChartInternal.prototype.xForColorScale = function () {
        var $$ = this;
        return (
            $$.config.stanford_padding.right +
            $$.colorScale.node().getBBox().width
        );
    };
    ...
    ChartInternal.prototype.getStanfordTooltipTitle = function (d) {
        ...
        return "\n      <tr><th>"
            .concat(labelX ? sanitise(labelX) : "x", "</th><th class='value'>")
            .concat(d.x, "</th></tr>\n      <tr><th>")
            .concat(labelY ? sanitise(labelY) : "y", "</th><th class='value'>")
            .concat(d.value, "</th></tr>\n    ");
    };
    ...
    ChartInternal.prototype.updateStanfordElements = function (duration) {
        ...
        stanfordLine = main
            ...
            .data(config.stanford_lines); // enter
        ...
        stanfordLineEnter = stanfordLine
            ...
            .attr("class", function (d) {
                return (
                    CLASS.stanfordLine + (d["class"] ? " " + d["class"] : "")
                );
            });
        stanfordLineEnter
            .append("line")
        ...
        stanfordTextEnter = stanfordText
            ...
            .attr("class", function (d) {
                return (
                    CLASS.stanfordText + (d["class"] ? " " + d["class"] : "")
                );
            });
        stanfordTextEnter
            .append("text")
        ...
        stanfordRegionEnter = stanfordRegion
            ...
            .attr("class", function (d) {
                return (
                    CLASS.stanfordRegion + (d["class"] ? " " + d["class"] : "")
                );
            });
        stanfordRegionEnter
            .append("polygon")
        ...
        if (config.tooltip_init_show) {
            if ($$.isTimeSeries() && isString(config.tooltip_init_x)) {
                ...
                for (i = 0; i < $$.data.targets[0].values.length; i++) {
                    if (
                        $$.data.targets[0].values[i].x -
                            config.tooltip_init_x ===
                        0
                    ) {
                        break;
                    }
    ...
    ChartInternal.prototype.getTooltipSortFunction = function () {
        ...
        if (
            config.data_groups.length === 0 ||
            config.tooltip_order !== undefined
        ) {
    ...
    ChartInternal.prototype.tooltipPosition = function (
        ...
        if (forArc) {
            ...
            if (config.axis_rotated) {
                ...
                tooltipLeft =
                    svgLeft +
                    $$.getCurrentPaddingLeft(true) +
                    $$.x(dataToShow[0].x) +
                    20;
                tooltipRight = tooltipLeft + tWidth;
                chartRight =
                    svgLeft + $$.currentWidth - $$.getCurrentPaddingRight();
    ...
    ChartInternal.prototype.showTooltip = function (selectedData, element) {
        ...
        var forArc = $$.hasArcType(),
            ...
            positionFunction =
                ...
                ChartInternal.prototype.tooltipPosition;
    ...
    ChartInternal.prototype.isSplineType = function (d) {
        var id = isString(d) ? d : d.id;
        return (
            ["spline", "area-spline"].indexOf(this.config.data_types[id]) >= 0
        );
    };
   ...
   */
    ...
    ChartInternal.prototype.initDragZoom = function () {
        ...
        var brush = ($$.dragZoomBrush = d3
            ...
            .on("brush", function () {
                config.zoom_onzoom.call(
                    $$.api,
                    getZoomedDomain(d3.event.selection)
                );
            })
            .on("end", function () {
