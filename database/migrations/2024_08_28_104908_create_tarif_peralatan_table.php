...
return new class extends Migration
{
    ...
    {
        Schema::create('tarif_peralatan', function (Blueprint $table) {
            $table->id();
            $table->foreignId('peralatan_id')->references('id')->on('peralatan')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('tarif_peralatan');
    }
};
