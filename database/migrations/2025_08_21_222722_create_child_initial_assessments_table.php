...
return new class extends Migration
{
    ...
    {
        Schema::create('child_initial_assessments', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('riwayat_kelahiran_imunisasi')->nullable();
            $table->json('riwayat_tumbuh_kembang')->nullable();
            ...
            $table->json('asesmen_nyeri_anak')->nullable();
            $table->json('resiko_jatuh_anak')->nullable();
    ...
    {
        Schema::dropIfExists('child_initial_assessments');
    }
};
