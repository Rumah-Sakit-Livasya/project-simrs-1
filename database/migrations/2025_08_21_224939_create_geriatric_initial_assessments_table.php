...
return new class extends Migration
{
    ...
    {
        Schema::create('geriatric_initial_assessments', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('status_fungsional')->nullable(); // Khusus Lansia
            $table->json('resiko_jatuh_lansia')->nullable(); // Khusus Lansia
    ...
    {
        Schema::dropIfExists('geriatric_initial_assessments');
    }
};
