...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('farmasi_reseps', function (Blueprint $table) {
            ...
            $table->foreignId('dokter_id')->nullable()->constrained('doctors')->onUpdate('cascade')->onDelete('cascade');
        });
    }
    ...
    public function down(): void
    {
        Schema::table('farmasi_reseps', function (Blueprint $table) {
            // Drop the existing foreign key constraint
            $table->dropForeign(['dokter_id']);
            // Re-add the foreign key constraint pointing back to 'employees' table
