...
return new class extends Migration
{
    ...
    {
        Schema::create('warehouse_penerimaan_barang_non_farmasi', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->softDeletes();
            ...
            $table->foreignId('po_id')->nullable()->constrained('procurement_purchase_order_non_pharmacy', 'id')->comment('Foreign Key to ProcurementPurchaseOrderNonPharmacy Table');
    ...
    {
        Schema::dropIfExists('warehouse_penerimaan_barang_non_farmasi');
    }
};
