...
return new class extends Migration
{
    ...
    {
        Schema::create('midwifery_initial_assessments', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('riwayat_kehamilan_saat_ini')->nullable();
            $table->json('riwayat_kehamilan_lalu')->nullable();
            $table->json('riwayat_kesehatan_pasien')->nullable();
            ...
            $table->json('diagnosa_kebidanan')->nullable();
    ...
    {
        Schema::dropIfExists('midwifery_initial_assessments');
    }
};
